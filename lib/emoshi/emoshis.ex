defmodule Emoshi.Emoshis do
  def emojis do
    [
      %Emoshi{slug: "grinning-face", name: "grinning face", status: :fully_qualified, emoji: "😀"},
      %Emoshi{
      ...
      %Emoshi{slug: "melting-face", name: "melting face", status: :fully_qualified, emoji: "🫠"},
      %Emoshi{slug: "winking-face", name: "winking face", status: :fully_qualified, emoji: "😉"},
      %Emoshi{
      ...
      %Emoshi{slug: "star-struck", name: "star-struck", status: :fully_qualified, emoji: "🤩"},
      %Emoshi{
      ...
      %Emoshi{slug: "kissing-face", name: "kissing face", status: :fully_qualified, emoji: "😗"},
      %Emoshi{slug: "smiling-face", name: "smiling face", status: :fully_qualified, emoji: "☺️"},
      %Emoshi{
      ...
      %Emoshi{slug: "zany-face", name: "zany face", status: :fully_qualified, emoji: "🤪"},
      %Emoshi{
      ...
      %Emoshi{slug: "shushing-face", name: "shushing face", status: :fully_qualified, emoji: "🤫"},
      %Emoshi{slug: "thinking-face", name: "thinking face", status: :fully_qualified, emoji: "🤔"},
      %Emoshi{slug: "saluting-face", name: "saluting face", status: :fully_qualified, emoji: "🫡"},
      %Emoshi{
      ...
      %Emoshi{slug: "neutral-face", name: "neutral face", status: :fully_qualified, emoji: "😐"},
      %Emoshi{
      ...
      %Emoshi{slug: "smirking-face", name: "smirking face", status: :fully_qualified, emoji: "😏"},
      %Emoshi{slug: "unamused-face", name: "unamused face", status: :fully_qualified, emoji: "😒"},
      %Emoshi{
      ...
      %Emoshi{slug: "face-exhaling", name: "face exhaling", status: :fully_qualified, emoji: "😮‍💨"},
      %Emoshi{slug: "lying-face", name: "lying face", status: :fully_qualified, emoji: "🤥"},
      %Emoshi{slug: "shaking-face", name: "shaking face", status: :fully_qualified, emoji: "🫨"},
      %Emoshi{
      ...
      %Emoshi{slug: "relieved-face", name: "relieved face", status: :fully_qualified, emoji: "😌"},
      %Emoshi{slug: "pensive-face", name: "pensive face", status: :fully_qualified, emoji: "😔"},
      %Emoshi{slug: "sleepy-face", name: "sleepy face", status: :fully_qualified, emoji: "😪"},
      %Emoshi{slug: "drooling-face", name: "drooling face", status: :fully_qualified, emoji: "🤤"},
      %Emoshi{slug: "sleeping-face", name: "sleeping face", status: :fully_qualified, emoji: "😴"},
      %Emoshi{
      ...
      %Emoshi{slug: "face-vomiting", name: "face vomiting", status: :fully_qualified, emoji: "🤮"},
      %Emoshi{slug: "sneezing-face", name: "sneezing face", status: :fully_qualified, emoji: "🤧"},
      %Emoshi{slug: "hot-face", name: "hot face", status: :fully_qualified, emoji: "🥵"},
      %Emoshi{slug: "cold-face", name: "cold face", status: :fully_qualified, emoji: "🥶"},
      %Emoshi{slug: "woozy-face", name: "woozy face", status: :fully_qualified, emoji: "🥴"},
      %Emoshi{
      ...
      %Emoshi{slug: "partying-face", name: "partying face", status: :fully_qualified, emoji: "🥳"},
      %Emoshi{
        slug: "disguised-face",
        name: "disguised face",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "nerd-face", name: "nerd face", status: :fully_qualified, emoji: "🤓"},
      %Emoshi{
      ...
      %Emoshi{slug: "confused-face", name: "confused face", status: :fully_qualified, emoji: "😕"},
      %Emoshi{
      ...
      %Emoshi{slug: "worried-face", name: "worried face", status: :fully_qualified, emoji: "😟"},
      %Emoshi{
      ...
      %Emoshi{slug: "frowning-face", name: "frowning face", status: :fully_qualified, emoji: "☹️"},
      %Emoshi{
      ...
      %Emoshi{slug: "hushed-face", name: "hushed face", status: :fully_qualified, emoji: "😯"},
      %Emoshi{
      ...
      %Emoshi{slug: "flushed-face", name: "flushed face", status: :fully_qualified, emoji: "😳"},
      %Emoshi{slug: "pleading-face", name: "pleading face", status: :fully_qualified, emoji: "🥺"},
      %Emoshi{
      ...
      %Emoshi{slug: "fearful-face", name: "fearful face", status: :fully_qualified, emoji: "😨"},
      %Emoshi{
      ...
      %Emoshi{slug: "crying-face", name: "crying face", status: :fully_qualified, emoji: "😢"},
      %Emoshi{
      ...
      %Emoshi{slug: "weary-face", name: "weary face", status: :fully_qualified, emoji: "😩"},
      %Emoshi{slug: "tired-face", name: "tired face", status: :fully_qualified, emoji: "😫"},
      %Emoshi{slug: "yawning-face", name: "yawning face", status: :fully_qualified, emoji: "🥱"},
      %Emoshi{
      ...
      %Emoshi{slug: "enraged-face", name: "enraged face", status: :fully_qualified, emoji: "😡"},
      %Emoshi{slug: "angry-face", name: "angry face", status: :fully_qualified, emoji: "😠"},
      %Emoshi{
      ...
      %Emoshi{slug: "skull", name: "skull", status: :fully_qualified, emoji: "💀"},
      %Emoshi{
      ...
      %Emoshi{slug: "pile-of-poo", name: "pile of poo", status: :fully_qualified, emoji: "💩"},
      %Emoshi{slug: "clown-face", name: "clown face", status: :fully_qualified, emoji: "🤡"},
      %Emoshi{slug: "ogre", name: "ogre", status: :fully_qualified, emoji: "👹"},
      %Emoshi{slug: "goblin", name: "goblin", status: :fully_qualified, emoji: "👺"},
      %Emoshi{slug: "ghost", name: "ghost", status: :fully_qualified, emoji: "👻"},
      %Emoshi{slug: "alien", name: "alien", status: :fully_qualified, emoji: "👽"},
      %Emoshi{slug: "alien-monster", name: "alien monster", status: :fully_qualified, emoji: "👾"},
      %Emoshi{slug: "robot", name: "robot", status: :fully_qualified, emoji: "🤖"},
      %Emoshi{slug: "grinning-cat", name: "grinning cat", status: :fully_qualified, emoji: "😺"},
      %Emoshi{
      ...
      %Emoshi{slug: "kissing-cat", name: "kissing cat", status: :fully_qualified, emoji: "😽"},
      %Emoshi{slug: "weary-cat", name: "weary cat", status: :fully_qualified, emoji: "🙀"},
      %Emoshi{slug: "crying-cat", name: "crying cat", status: :fully_qualified, emoji: "😿"},
      %Emoshi{slug: "pouting-cat", name: "pouting cat", status: :fully_qualified, emoji: "😾"},
      %Emoshi{
      ...
      %Emoshi{slug: "love-letter", name: "love letter", status: :fully_qualified, emoji: "💌"},
      %Emoshi{
      ...
      %Emoshi{slug: "growing-heart", name: "growing heart", status: :fully_qualified, emoji: "💗"},
      %Emoshi{slug: "beating-heart", name: "beating heart", status: :fully_qualified, emoji: "💓"},
      %Emoshi{
      ...
      %Emoshi{slug: "two-hearts", name: "two hearts", status: :fully_qualified, emoji: "💕"},
      %Emoshi{
      ...
      %Emoshi{slug: "broken-heart", name: "broken heart", status: :fully_qualified, emoji: "💔"},
      %Emoshi{slug: "heart-on-fire", name: "heart on fire", status: :fully_qualified, emoji: "❤️‍🔥"},
      %Emoshi{slug: "mending-heart", name: "mending heart", status: :fully_qualified, emoji: "❤️‍🩹"},
      %Emoshi{slug: "red-heart", name: "red heart", status: :fully_qualified, emoji: "❤️"},
      %Emoshi{slug: "pink-heart", name: "pink heart", status: :fully_qualified, emoji: "🩷"},
      %Emoshi{slug: "orange-heart", name: "orange heart", status: :fully_qualified, emoji: "🧡"},
      %Emoshi{slug: "yellow-heart", name: "yellow heart", status: :fully_qualified, emoji: "💛"},
      %Emoshi{slug: "green-heart", name: "green heart", status: :fully_qualified, emoji: "💚"},
      %Emoshi{slug: "blue-heart", name: "blue heart", status: :fully_qualified, emoji: "💙"},
      %Emoshi{
      ...
      %Emoshi{slug: "purple-heart", name: "purple heart", status: :fully_qualified, emoji: "💜"},
      %Emoshi{slug: "brown-heart", name: "brown heart", status: :fully_qualified, emoji: "🤎"},
      %Emoshi{slug: "black-heart", name: "black heart", status: :fully_qualified, emoji: "🖤"},
      %Emoshi{slug: "grey-heart", name: "grey heart", status: :fully_qualified, emoji: "🩶"},
      %Emoshi{slug: "white-heart", name: "white heart", status: :fully_qualified, emoji: "🤍"},
      %Emoshi{slug: "kiss-mark", name: "kiss mark", status: :fully_qualified, emoji: "💋"},
      %Emoshi{
        slug: "hundred-points",
        name: "hundred points",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "anger-symbol", name: "anger symbol", status: :fully_qualified, emoji: "💢"},
      %Emoshi{slug: "collision", name: "collision", status: :fully_qualified, emoji: "💥"},
      %Emoshi{slug: "dizzy", name: "dizzy", status: :fully_qualified, emoji: "💫"},
      %Emoshi{
        slug: "sweat-droplets",
        name: "sweat droplets",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "dashing-away", name: "dashing away", status: :fully_qualified, emoji: "💨"},
      %Emoshi{slug: "hole", name: "hole", status: :fully_qualified, emoji: "🕳️"},
      %Emoshi{
        slug: "speech-balloon",
        name: "speech balloon",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "zzz", name: "ZZZ", status: :fully_qualified, emoji: "💤"},
      %Emoshi{slug: "waving-hand", name: "waving hand", status: :fully_qualified, emoji: "👋"},
      %Emoshi{
      ...
      %Emoshi{slug: "raised-hand", name: "raised hand", status: :fully_qualified, emoji: "✋"},
      %Emoshi{
      ...
      %Emoshi{slug: "vulcan-salute", name: "vulcan salute", status: :fully_qualified, emoji: "🖖"},
      %Emoshi{
      ...
      %Emoshi{slug: "palm-up-hand", name: "palm up hand", status: :fully_qualified, emoji: "🫴"},
      %Emoshi{
      ...
      %Emoshi{slug: "ok-hand", name: "OK hand", status: :fully_qualified, emoji: "👌"},
      %Emoshi{
      ...
      %Emoshi{slug: "pinching-hand", name: "pinching hand", status: :fully_qualified, emoji: "🤏"},
      %Emoshi{
      ...
      %Emoshi{slug: "victory-hand", name: "victory hand", status: :fully_qualified, emoji: "✌️"},
      %Emoshi{
      ...
      %Emoshi{slug: "call-me-hand", name: "call me hand", status: :fully_qualified, emoji: "🤙"},
      %Emoshi{
      ...
      %Emoshi{slug: "middle-finger", name: "middle finger", status: :fully_qualified, emoji: "🖕"},
      %Emoshi{
      ...
      %Emoshi{slug: "thumbs-up", name: "thumbs up", status: :fully_qualified, emoji: "👍"},
      %Emoshi{
      ...
      %Emoshi{slug: "thumbs-down", name: "thumbs down", status: :fully_qualified, emoji: "👎"},
      %Emoshi{
      ...
      %Emoshi{slug: "raised-fist", name: "raised fist", status: :fully_qualified, emoji: "✊"},
      %Emoshi{
      ...
      %Emoshi{slug: "oncoming-fist", name: "oncoming fist", status: :fully_qualified, emoji: "👊"},
      %Emoshi{
      ...
      %Emoshi{slug: "raising-hands", name: "raising hands", status: :fully_qualified, emoji: "🙌"},
      %Emoshi{
      ...
      %Emoshi{slug: "heart-hands", name: "heart hands", status: :fully_qualified, emoji: "🫶"},
      %Emoshi{
      ...
      %Emoshi{slug: "open-hands", name: "open hands", status: :fully_qualified, emoji: "👐"},
      %Emoshi{
      ...
      %Emoshi{slug: "handshake", name: "handshake", status: :fully_qualified, emoji: "🤝"},
      %Emoshi{
      ...
      %Emoshi{slug: "folded-hands", name: "folded hands", status: :fully_qualified, emoji: "🙏"},
      %Emoshi{
      ...
      %Emoshi{slug: "writing-hand", name: "writing hand", status: :fully_qualified, emoji: "✍️"},
      %Emoshi{
      ...
      %Emoshi{slug: "nail-polish", name: "nail polish", status: :fully_qualified, emoji: "💅"},
      %Emoshi{
      ...
      %Emoshi{slug: "selfie", name: "selfie", status: :fully_qualified, emoji: "🤳"},
      %Emoshi{
      ...
      %Emoshi{slug: "flexed-biceps", name: "flexed biceps", status: :fully_qualified, emoji: "💪"},
      %Emoshi{
      ...
      %Emoshi{slug: "leg", name: "leg", status: :fully_qualified, emoji: "🦵"},
      %Emoshi{
      ...
      %Emoshi{slug: "foot", name: "foot", status: :fully_qualified, emoji: "🦶"},
      %Emoshi{
      ...
      %Emoshi{slug: "ear", name: "ear", status: :fully_qualified, emoji: "👂"},
      %Emoshi{
      ...
      %Emoshi{slug: "nose", name: "nose", status: :fully_qualified, emoji: "👃"},
      %Emoshi{
      ...
      %Emoshi{slug: "brain", name: "brain", status: :fully_qualified, emoji: "🧠"},
      %Emoshi{
      ...
      %Emoshi{slug: "lungs", name: "lungs", status: :fully_qualified, emoji: "🫁"},
      %Emoshi{slug: "tooth", name: "tooth", status: :fully_qualified, emoji: "🦷"},
      %Emoshi{slug: "bone", name: "bone", status: :fully_qualified, emoji: "🦴"},
      %Emoshi{slug: "eyes", name: "eyes", status: :fully_qualified, emoji: "👀"},
      %Emoshi{slug: "eye", name: "eye", status: :fully_qualified, emoji: "👁️"},
      %Emoshi{slug: "tongue", name: "tongue", status: :fully_qualified, emoji: "👅"},
      %Emoshi{slug: "mouth", name: "mouth", status: :fully_qualified, emoji: "👄"},
      %Emoshi{slug: "biting-lip", name: "biting lip", status: :fully_qualified, emoji: "🫦"},
      %Emoshi{slug: "baby", name: "baby", status: :fully_qualified, emoji: "👶"},
      %Emoshi{
      ...
      %Emoshi{slug: "child", name: "child", status: :fully_qualified, emoji: "🧒"},
      %Emoshi{
      ...
      %Emoshi{slug: "boy", name: "boy", status: :fully_qualified, emoji: "👦"},
      %Emoshi{
      ...
      %Emoshi{slug: "girl", name: "girl", status: :fully_qualified, emoji: "👧"},
      %Emoshi{
      ...
      %Emoshi{slug: "person", name: "person", status: :fully_qualified, emoji: "🧑"},
      %Emoshi{
      ...
      %Emoshi{slug: "man", name: "man", status: :fully_qualified, emoji: "👨"},
      %Emoshi{
      ...
      %Emoshi{slug: "person-beard", name: "person: beard", status: :fully_qualified, emoji: "🧔"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-beard", name: "man: beard", status: :fully_qualified, emoji: "🧔‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-beard", name: "woman: beard", status: :fully_qualified, emoji: "🧔‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-red-hair", name: "man: red hair", status: :fully_qualified, emoji: "👨‍🦰"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-bald", name: "man: bald", status: :fully_qualified, emoji: "👨‍🦲"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman", name: "woman", status: :fully_qualified, emoji: "👩"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-bald", name: "woman: bald", status: :fully_qualified, emoji: "👩‍🦲"},
      %Emoshi{
      ...
      %Emoshi{slug: "person-bald", name: "person: bald", status: :fully_qualified, emoji: "🧑‍🦲"},
      %Emoshi{
      ...
      %Emoshi{slug: "older-person", name: "older person", status: :fully_qualified, emoji: "🧓"},
      %Emoshi{
      ...
      %Emoshi{slug: "old-man", name: "old man", status: :fully_qualified, emoji: "👴"},
      %Emoshi{
      ...
      %Emoshi{slug: "old-woman", name: "old woman", status: :fully_qualified, emoji: "👵"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-frowning", name: "man frowning", status: :fully_qualified, emoji: "🙍‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-pouting", name: "man pouting", status: :fully_qualified, emoji: "🙎‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-pouting", name: "woman pouting", status: :fully_qualified, emoji: "🙎‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "deaf-person", name: "deaf person", status: :fully_qualified, emoji: "🧏"},
      %Emoshi{
      ...
      %Emoshi{slug: "deaf-man", name: "deaf man", status: :fully_qualified, emoji: "🧏‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "deaf-woman", name: "deaf woman", status: :fully_qualified, emoji: "🧏‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "person-bowing", name: "person bowing", status: :fully_qualified, emoji: "🙇"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-bowing", name: "man bowing", status: :fully_qualified, emoji: "🙇‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-bowing", name: "woman bowing", status: :fully_qualified, emoji: "🙇‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-shrugging", name: "man shrugging", status: :fully_qualified, emoji: "🤷‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "health-worker", name: "health worker", status: :fully_qualified, emoji: "🧑‍⚕️"},
      %Emoshi{
      ...
      %Emoshi{slug: "student", name: "student", status: :fully_qualified, emoji: "🧑‍🎓"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-student", name: "man student", status: :fully_qualified, emoji: "👨‍🎓"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-student", name: "woman student", status: :fully_qualified, emoji: "👩‍🎓"},
      %Emoshi{
      ...
      %Emoshi{slug: "teacher", name: "teacher", status: :fully_qualified, emoji: "🧑‍🏫"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-teacher", name: "man teacher", status: :fully_qualified, emoji: "👨‍🏫"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-teacher", name: "woman teacher", status: :fully_qualified, emoji: "👩‍🏫"},
      %Emoshi{
      ...
      %Emoshi{slug: "judge", name: "judge", status: :fully_qualified, emoji: "🧑‍⚖️"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-judge", name: "man judge", status: :fully_qualified, emoji: "👨‍⚖️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-judge", name: "woman judge", status: :fully_qualified, emoji: "👩‍⚖️"},
      %Emoshi{
      ...
      %Emoshi{slug: "farmer", name: "farmer", status: :fully_qualified, emoji: "🧑‍🌾"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-farmer", name: "man farmer", status: :fully_qualified, emoji: "👨‍🌾"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-farmer", name: "woman farmer", status: :fully_qualified, emoji: "👩‍🌾"},
      %Emoshi{
      ...
      %Emoshi{slug: "cook", name: "cook", status: :fully_qualified, emoji: "🧑‍🍳"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-cook", name: "man cook", status: :fully_qualified, emoji: "👨‍🍳"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-cook", name: "woman cook", status: :fully_qualified, emoji: "👩‍🍳"},
      %Emoshi{
      ...
      %Emoshi{slug: "mechanic", name: "mechanic", status: :fully_qualified, emoji: "🧑‍🔧"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-mechanic", name: "man mechanic", status: :fully_qualified, emoji: "👨‍🔧"},
      %Emoshi{
      ...
      %Emoshi{slug: "office-worker", name: "office worker", status: :fully_qualified, emoji: "🧑‍💼"},
      %Emoshi{
      ...
      %Emoshi{slug: "scientist", name: "scientist", status: :fully_qualified, emoji: "🧑‍🔬"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-scientist", name: "man scientist", status: :fully_qualified, emoji: "👨‍🔬"},
      %Emoshi{
      ...
      %Emoshi{slug: "technologist", name: "technologist", status: :fully_qualified, emoji: "🧑‍💻"},
      %Emoshi{
      ...
      %Emoshi{slug: "singer", name: "singer", status: :fully_qualified, emoji: "🧑‍🎤"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-singer", name: "man singer", status: :fully_qualified, emoji: "👨‍🎤"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-singer", name: "woman singer", status: :fully_qualified, emoji: "👩‍🎤"},
      %Emoshi{
      ...
      %Emoshi{slug: "artist", name: "artist", status: :fully_qualified, emoji: "🧑‍🎨"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-artist", name: "man artist", status: :fully_qualified, emoji: "👨‍🎨"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-artist", name: "woman artist", status: :fully_qualified, emoji: "👩‍🎨"},
      %Emoshi{
      ...
      %Emoshi{slug: "pilot", name: "pilot", status: :fully_qualified, emoji: "🧑‍✈️"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-pilot", name: "man pilot", status: :fully_qualified, emoji: "👨‍✈️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-pilot", name: "woman pilot", status: :fully_qualified, emoji: "👩‍✈️"},
      %Emoshi{
      ...
      %Emoshi{slug: "astronaut", name: "astronaut", status: :fully_qualified, emoji: "🧑‍🚀"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-astronaut", name: "man astronaut", status: :fully_qualified, emoji: "👨‍🚀"},
      %Emoshi{
      ...
      %Emoshi{slug: "firefighter", name: "firefighter", status: :fully_qualified, emoji: "🧑‍🚒"},
      %Emoshi{
      ...
      %Emoshi{slug: "detective", name: "detective", status: :fully_qualified, emoji: "🕵️"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-detective", name: "man detective", status: :fully_qualified, emoji: "🕵️‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "guard", name: "guard", status: :fully_qualified, emoji: "💂"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-guard", name: "man guard", status: :fully_qualified, emoji: "💂‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-guard", name: "woman guard", status: :fully_qualified, emoji: "💂‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "ninja", name: "ninja", status: :fully_qualified, emoji: "🥷"},
      %Emoshi{
      ...
      %Emoshi{slug: "prince", name: "prince", status: :fully_qualified, emoji: "🤴"},
      %Emoshi{
      ...
      %Emoshi{slug: "princess", name: "princess", status: :fully_qualified, emoji: "👸"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-in-tuxedo", name: "man in tuxedo", status: :fully_qualified, emoji: "🤵‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-with-veil", name: "man with veil", status: :fully_qualified, emoji: "👰‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "pregnant-man", name: "pregnant man", status: :fully_qualified, emoji: "🫃"},
      %Emoshi{
      ...
      %Emoshi{slug: "baby-angel", name: "baby angel", status: :fully_qualified, emoji: "👼"},
      %Emoshi{
      ...
      %Emoshi{slug: "santa-claus", name: "Santa Claus", status: :fully_qualified, emoji: "🎅"},
      %Emoshi{
      ...
      %Emoshi{slug: "mrs-claus", name: "Mrs. Claus", status: :fully_qualified, emoji: "🤶"},
      %Emoshi{
      ...
      %Emoshi{slug: "mx-claus", name: "Mx Claus", status: :fully_qualified, emoji: "🧑‍🎄"},
      %Emoshi{
      ...
      %Emoshi{slug: "superhero", name: "superhero", status: :fully_qualified, emoji: "🦸"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-superhero", name: "man superhero", status: :fully_qualified, emoji: "🦸‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "supervillain", name: "supervillain", status: :fully_qualified, emoji: "🦹"},
      %Emoshi{
      ...
      %Emoshi{slug: "mage", name: "mage", status: :fully_qualified, emoji: "🧙"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-mage", name: "man mage", status: :fully_qualified, emoji: "🧙‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-mage", name: "woman mage", status: :fully_qualified, emoji: "🧙‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "fairy", name: "fairy", status: :fully_qualified, emoji: "🧚"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-fairy", name: "man fairy", status: :fully_qualified, emoji: "🧚‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-fairy", name: "woman fairy", status: :fully_qualified, emoji: "🧚‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "vampire", name: "vampire", status: :fully_qualified, emoji: "🧛"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-vampire", name: "man vampire", status: :fully_qualified, emoji: "🧛‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-vampire", name: "woman vampire", status: :fully_qualified, emoji: "🧛‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "merperson", name: "merperson", status: :fully_qualified, emoji: "🧜"},
      %Emoshi{
      ...
      %Emoshi{slug: "merman", name: "merman", status: :fully_qualified, emoji: "🧜‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "mermaid", name: "mermaid", status: :fully_qualified, emoji: "🧜‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "elf", name: "elf", status: :fully_qualified, emoji: "🧝"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-elf", name: "man elf", status: :fully_qualified, emoji: "🧝‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-elf", name: "woman elf", status: :fully_qualified, emoji: "🧝‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "genie", name: "genie", status: :fully_qualified, emoji: "🧞"},
      %Emoshi{slug: "man-genie", name: "man genie", status: :fully_qualified, emoji: "🧞‍♂️"},
      %Emoshi{slug: "woman-genie", name: "woman genie", status: :fully_qualified, emoji: "🧞‍♀️"},
      %Emoshi{slug: "zombie", name: "zombie", status: :fully_qualified, emoji: "🧟"},
      %Emoshi{slug: "man-zombie", name: "man zombie", status: :fully_qualified, emoji: "🧟‍♂️"},
      %Emoshi{slug: "woman-zombie", name: "woman zombie", status: :fully_qualified, emoji: "🧟‍♀️"},
      %Emoshi{slug: "troll", name: "troll", status: :fully_qualified, emoji: "🧌"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-walking", name: "man walking", status: :fully_qualified, emoji: "🚶‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-walking", name: "woman walking", status: :fully_qualified, emoji: "🚶‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-standing", name: "man standing", status: :fully_qualified, emoji: "🧍‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-kneeling", name: "man kneeling", status: :fully_qualified, emoji: "🧎‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-running", name: "man running", status: :fully_qualified, emoji: "🏃‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-running", name: "woman running", status: :fully_qualified, emoji: "🏃‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-dancing", name: "woman dancing", status: :fully_qualified, emoji: "💃"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-dancing", name: "man dancing", status: :fully_qualified, emoji: "🕺"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-climbing", name: "man climbing", status: :fully_qualified, emoji: "🧗‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "horse-racing", name: "horse racing", status: :fully_qualified, emoji: "🏇"},
      %Emoshi{
      ...
      %Emoshi{slug: "skier", name: "skier", status: :fully_qualified, emoji: "⛷️"},
      %Emoshi{slug: "snowboarder", name: "snowboarder", status: :fully_qualified, emoji: "🏂"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-golfing", name: "man golfing", status: :fully_qualified, emoji: "🏌️‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-golfing", name: "woman golfing", status: :fully_qualified, emoji: "🏌️‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-surfing", name: "man surfing", status: :fully_qualified, emoji: "🏄‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-surfing", name: "woman surfing", status: :fully_qualified, emoji: "🏄‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-swimming", name: "man swimming", status: :fully_qualified, emoji: "🏊‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "person-biking", name: "person biking", status: :fully_qualified, emoji: "🚴"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-biking", name: "man biking", status: :fully_qualified, emoji: "🚴‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "woman-biking", name: "woman biking", status: :fully_qualified, emoji: "🚴‍♀️"},
      %Emoshi{
      ...
      %Emoshi{slug: "men-wrestling", name: "men wrestling", status: :fully_qualified, emoji: "🤼‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "man-juggling", name: "man juggling", status: :fully_qualified, emoji: "🤹‍♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "person-in-bed", name: "person in bed", status: :fully_qualified, emoji: "🛌"},
      %Emoshi{
      ...
      %Emoshi{slug: "kiss", name: "kiss", status: :fully_qualified, emoji: "💏"},
      %Emoshi{
      ...
      %Emoshi{slug: "kiss-man-man", name: "kiss: man, man", status: :fully_qualified, emoji: "👨‍❤️‍💋‍👨"},
      %Emoshi{
      ...
      %Emoshi{slug: "speaking-head", name: "speaking head", status: :fully_qualified, emoji: "🗣️"},
      %Emoshi{
      ...
      %Emoshi{slug: "family", name: "family", status: :fully_qualified, emoji: "👪"},
      %Emoshi{
      ...
      %Emoshi{slug: "footprints", name: "footprints", status: :fully_qualified, emoji: "👣"},
      %Emoshi{slug: "fingerprint", name: "fingerprint", status: :fully_qualified, emoji: "🫆"},
      %Emoshi{slug: "monkey-face", name: "monkey face", status: :fully_qualified, emoji: "🐵"},
      %Emoshi{slug: "monkey", name: "monkey", status: :fully_qualified, emoji: "🐒"},
      %Emoshi{slug: "gorilla", name: "gorilla", status: :fully_qualified, emoji: "🦍"},
      %Emoshi{slug: "orangutan", name: "orangutan", status: :fully_qualified, emoji: "🦧"},
      %Emoshi{slug: "dog-face", name: "dog face", status: :fully_qualified, emoji: "🐶"},
      %Emoshi{slug: "dog", name: "dog", status: :fully_qualified, emoji: "🐕"},
      %Emoshi{slug: "guide-dog", name: "guide dog", status: :fully_qualified, emoji: "🦮"},
      %Emoshi{slug: "service-dog", name: "service dog", status: :fully_qualified, emoji: "🐕‍🦺"},
      %Emoshi{slug: "poodle", name: "poodle", status: :fully_qualified, emoji: "🐩"},
      %Emoshi{slug: "wolf", name: "wolf", status: :fully_qualified, emoji: "🐺"},
      %Emoshi{slug: "fox", name: "fox", status: :fully_qualified, emoji: "🦊"},
      %Emoshi{slug: "raccoon", name: "raccoon", status: :fully_qualified, emoji: "🦝"},
      %Emoshi{slug: "cat-face", name: "cat face", status: :fully_qualified, emoji: "🐱"},
      %Emoshi{slug: "cat", name: "cat", status: :fully_qualified, emoji: "🐈"},
      %Emoshi{slug: "black-cat", name: "black cat", status: :fully_qualified, emoji: "🐈‍⬛"},
      %Emoshi{slug: "lion", name: "lion", status: :fully_qualified, emoji: "🦁"},
      %Emoshi{slug: "tiger-face", name: "tiger face", status: :fully_qualified, emoji: "🐯"},
      %Emoshi{slug: "tiger", name: "tiger", status: :fully_qualified, emoji: "🐅"},
      %Emoshi{slug: "leopard", name: "leopard", status: :fully_qualified, emoji: "🐆"},
      %Emoshi{slug: "horse-face", name: "horse face", status: :fully_qualified, emoji: "🐴"},
      %Emoshi{slug: "moose", name: "moose", status: :fully_qualified, emoji: "🫎"},
      %Emoshi{slug: "donkey", name: "donkey", status: :fully_qualified, emoji: "🫏"},
      %Emoshi{slug: "horse", name: "horse", status: :fully_qualified, emoji: "🐎"},
      %Emoshi{slug: "unicorn", name: "unicorn", status: :fully_qualified, emoji: "🦄"},
      %Emoshi{slug: "zebra", name: "zebra", status: :fully_qualified, emoji: "🦓"},
      %Emoshi{slug: "deer", name: "deer", status: :fully_qualified, emoji: "🦌"},
      %Emoshi{slug: "bison", name: "bison", status: :fully_qualified, emoji: "🦬"},
      %Emoshi{slug: "cow-face", name: "cow face", status: :fully_qualified, emoji: "🐮"},
      %Emoshi{slug: "ox", name: "ox", status: :fully_qualified, emoji: "🐂"},
      %Emoshi{slug: "water-buffalo", name: "water buffalo", status: :fully_qualified, emoji: "🐃"},
      %Emoshi{slug: "cow", name: "cow", status: :fully_qualified, emoji: "🐄"},
      %Emoshi{slug: "pig-face", name: "pig face", status: :fully_qualified, emoji: "🐷"},
      %Emoshi{slug: "pig", name: "pig", status: :fully_qualified, emoji: "🐖"},
      %Emoshi{slug: "boar", name: "boar", status: :fully_qualified, emoji: "🐗"},
      %Emoshi{slug: "pig-nose", name: "pig nose", status: :fully_qualified, emoji: "🐽"},
      %Emoshi{slug: "ram", name: "ram", status: :fully_qualified, emoji: "🐏"},
      %Emoshi{slug: "ewe", name: "ewe", status: :fully_qualified, emoji: "🐑"},
      %Emoshi{slug: "goat", name: "goat", status: :fully_qualified, emoji: "🐐"},
      %Emoshi{slug: "camel", name: "camel", status: :fully_qualified, emoji: "🐪"},
      %Emoshi{
        slug: "two-hump-camel",
        name: "two-hump camel",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "llama", name: "llama", status: :fully_qualified, emoji: "🦙"},
      %Emoshi{slug: "giraffe", name: "giraffe", status: :fully_qualified, emoji: "🦒"},
      %Emoshi{slug: "elephant", name: "elephant", status: :fully_qualified, emoji: "🐘"},
      %Emoshi{slug: "mammoth", name: "mammoth", status: :fully_qualified, emoji: "🦣"},
      %Emoshi{slug: "rhinoceros", name: "rhinoceros", status: :fully_qualified, emoji: "🦏"},
      %Emoshi{slug: "hippopotamus", name: "hippopotamus", status: :fully_qualified, emoji: "🦛"},
      %Emoshi{slug: "mouse-face", name: "mouse face", status: :fully_qualified, emoji: "🐭"},
      %Emoshi{slug: "mouse", name: "mouse", status: :fully_qualified, emoji: "🐁"},
      %Emoshi{slug: "rat", name: "rat", status: :fully_qualified, emoji: "🐀"},
      %Emoshi{slug: "hamster", name: "hamster", status: :fully_qualified, emoji: "🐹"},
      %Emoshi{slug: "rabbit-face", name: "rabbit face", status: :fully_qualified, emoji: "🐰"},
      %Emoshi{slug: "rabbit", name: "rabbit", status: :fully_qualified, emoji: "🐇"},
      %Emoshi{slug: "chipmunk", name: "chipmunk", status: :fully_qualified, emoji: "🐿️"},
      %Emoshi{slug: "beaver", name: "beaver", status: :fully_qualified, emoji: "🦫"},
      %Emoshi{slug: "hedgehog", name: "hedgehog", status: :fully_qualified, emoji: "🦔"},
      %Emoshi{slug: "bat", name: "bat", status: :fully_qualified, emoji: "🦇"},
      %Emoshi{slug: "bear", name: "bear", status: :fully_qualified, emoji: "🐻"},
      %Emoshi{slug: "polar-bear", name: "polar bear", status: :fully_qualified, emoji: "🐻‍❄️"},
      %Emoshi{slug: "koala", name: "koala", status: :fully_qualified, emoji: "🐨"},
      %Emoshi{slug: "panda", name: "panda", status: :fully_qualified, emoji: "🐼"},
      %Emoshi{slug: "sloth", name: "sloth", status: :fully_qualified, emoji: "🦥"},
      %Emoshi{slug: "otter", name: "otter", status: :fully_qualified, emoji: "🦦"},
      %Emoshi{slug: "skunk", name: "skunk", status: :fully_qualified, emoji: "🦨"},
      %Emoshi{slug: "kangaroo", name: "kangaroo", status: :fully_qualified, emoji: "🦘"},
      %Emoshi{slug: "badger", name: "badger", status: :fully_qualified, emoji: "🦡"},
      %Emoshi{slug: "paw-prints", name: "paw prints", status: :fully_qualified, emoji: "🐾"},
      %Emoshi{slug: "turkey", name: "turkey", status: :fully_qualified, emoji: "🦃"},
      %Emoshi{slug: "chicken", name: "chicken", status: :fully_qualified, emoji: "🐔"},
      %Emoshi{slug: "rooster", name: "rooster", status: :fully_qualified, emoji: "🐓"},
      %Emoshi{
        slug: "hatching-chick",
        name: "hatching chick",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "baby-chick", name: "baby chick", status: :fully_qualified, emoji: "🐤"},
      %Emoshi{
      ...
      %Emoshi{slug: "bird", name: "bird", status: :fully_qualified, emoji: "🐦"},
      %Emoshi{slug: "penguin", name: "penguin", status: :fully_qualified, emoji: "🐧"},
      %Emoshi{slug: "dove", name: "dove", status: :fully_qualified, emoji: "🕊️"},
      %Emoshi{slug: "eagle", name: "eagle", status: :fully_qualified, emoji: "🦅"},
      %Emoshi{slug: "duck", name: "duck", status: :fully_qualified, emoji: "🦆"},
      %Emoshi{slug: "swan", name: "swan", status: :fully_qualified, emoji: "🦢"},
      %Emoshi{slug: "owl", name: "owl", status: :fully_qualified, emoji: "🦉"},
      %Emoshi{slug: "dodo", name: "dodo", status: :fully_qualified, emoji: "🦤"},
      %Emoshi{slug: "feather", name: "feather", status: :fully_qualified, emoji: "🪶"},
      %Emoshi{slug: "flamingo", name: "flamingo", status: :fully_qualified, emoji: "🦩"},
      %Emoshi{slug: "peacock", name: "peacock", status: :fully_qualified, emoji: "🦚"},
      %Emoshi{slug: "parrot", name: "parrot", status: :fully_qualified, emoji: "🦜"},
      %Emoshi{slug: "wing", name: "wing", status: :fully_qualified, emoji: "🪽"},
      %Emoshi{slug: "black-bird", name: "black bird", status: :fully_qualified, emoji: "🐦‍⬛"},
      %Emoshi{slug: "goose", name: "goose", status: :fully_qualified, emoji: "🪿"},
      %Emoshi{slug: "phoenix", name: "phoenix", status: :fully_qualified, emoji: "🐦‍🔥"},
      %Emoshi{slug: "frog", name: "frog", status: :fully_qualified, emoji: "🐸"},
      %Emoshi{slug: "crocodile", name: "crocodile", status: :fully_qualified, emoji: "🐊"},
      %Emoshi{slug: "turtle", name: "turtle", status: :fully_qualified, emoji: "🐢"},
      %Emoshi{slug: "lizard", name: "lizard", status: :fully_qualified, emoji: "🦎"},
      %Emoshi{slug: "snake", name: "snake", status: :fully_qualified, emoji: "🐍"},
      %Emoshi{slug: "dragon-face", name: "dragon face", status: :fully_qualified, emoji: "🐲"},
      %Emoshi{slug: "dragon", name: "dragon", status: :fully_qualified, emoji: "🐉"},
      %Emoshi{slug: "sauropod", name: "sauropod", status: :fully_qualified, emoji: "🦕"},
      %Emoshi{slug: "t-rex", name: "T-Rex", status: :fully_qualified, emoji: "🦖"},
      %Emoshi{
        slug: "spouting-whale",
        name: "spouting whale",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "whale", name: "whale", status: :fully_qualified, emoji: "🐋"},
      %Emoshi{slug: "dolphin", name: "dolphin", status: :fully_qualified, emoji: "🐬"},
      %Emoshi{slug: "seal", name: "seal", status: :fully_qualified, emoji: "🦭"},
      %Emoshi{slug: "fish", name: "fish", status: :fully_qualified, emoji: "🐟"},
      %Emoshi{slug: "tropical-fish", name: "tropical fish", status: :fully_qualified, emoji: "🐠"},
      %Emoshi{slug: "blowfish", name: "blowfish", status: :fully_qualified, emoji: "🐡"},
      %Emoshi{slug: "shark", name: "shark", status: :fully_qualified, emoji: "🦈"},
      %Emoshi{slug: "octopus", name: "octopus", status: :fully_qualified, emoji: "🐙"},
      %Emoshi{slug: "spiral-shell", name: "spiral shell", status: :fully_qualified, emoji: "🐚"},
      %Emoshi{slug: "coral", name: "coral", status: :fully_qualified, emoji: "🪸"},
      %Emoshi{slug: "jellyfish", name: "jellyfish", status: :fully_qualified, emoji: "🪼"},
      %Emoshi{slug: "crab", name: "crab", status: :fully_qualified, emoji: "🦀"},
      %Emoshi{slug: "lobster", name: "lobster", status: :fully_qualified, emoji: "🦞"},
      %Emoshi{slug: "shrimp", name: "shrimp", status: :fully_qualified, emoji: "🦐"},
      %Emoshi{slug: "squid", name: "squid", status: :fully_qualified, emoji: "🦑"},
      %Emoshi{slug: "oyster", name: "oyster", status: :fully_qualified, emoji: "🦪"},
      %Emoshi{slug: "snail", name: "snail", status: :fully_qualified, emoji: "🐌"},
      %Emoshi{slug: "butterfly", name: "butterfly", status: :fully_qualified, emoji: "🦋"},
      %Emoshi{slug: "bug", name: "bug", status: :fully_qualified, emoji: "🐛"},
      %Emoshi{slug: "ant", name: "ant", status: :fully_qualified, emoji: "🐜"},
      %Emoshi{slug: "honeybee", name: "honeybee", status: :fully_qualified, emoji: "🐝"},
      %Emoshi{slug: "beetle", name: "beetle", status: :fully_qualified, emoji: "🪲"},
      %Emoshi{slug: "lady-beetle", name: "lady beetle", status: :fully_qualified, emoji: "🐞"},
      %Emoshi{slug: "cricket", name: "cricket", status: :fully_qualified, emoji: "🦗"},
      %Emoshi{slug: "cockroach", name: "cockroach", status: :fully_qualified, emoji: "🪳"},
      %Emoshi{slug: "spider", name: "spider", status: :fully_qualified, emoji: "🕷️"},
      %Emoshi{slug: "spider-web", name: "spider web", status: :fully_qualified, emoji: "🕸️"},
      %Emoshi{slug: "scorpion", name: "scorpion", status: :fully_qualified, emoji: "🦂"},
      %Emoshi{slug: "mosquito", name: "mosquito", status: :fully_qualified, emoji: "🦟"},
      %Emoshi{slug: "fly", name: "fly", status: :fully_qualified, emoji: "🪰"},
      %Emoshi{slug: "worm", name: "worm", status: :fully_qualified, emoji: "🪱"},
      %Emoshi{slug: "microbe", name: "microbe", status: :fully_qualified, emoji: "🦠"},
      %Emoshi{slug: "bouquet", name: "bouquet", status: :fully_qualified, emoji: "💐"},
      %Emoshi{
        slug: "cherry-blossom",
        name: "cherry blossom",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "white-flower", name: "white flower", status: :fully_qualified, emoji: "💮"},
      %Emoshi{slug: "lotus", name: "lotus", status: :fully_qualified, emoji: "🪷"},
      %Emoshi{slug: "rosette", name: "rosette", status: :fully_qualified, emoji: "🏵️"},
      %Emoshi{slug: "rose", name: "rose", status: :fully_qualified, emoji: "🌹"},
      %Emoshi{slug: "wilted-flower", name: "wilted flower", status: :fully_qualified, emoji: "🥀"},
      %Emoshi{slug: "hibiscus", name: "hibiscus", status: :fully_qualified, emoji: "🌺"},
      %Emoshi{slug: "sunflower", name: "sunflower", status: :fully_qualified, emoji: "🌻"},
      %Emoshi{slug: "blossom", name: "blossom", status: :fully_qualified, emoji: "🌼"},
      %Emoshi{slug: "tulip", name: "tulip", status: :fully_qualified, emoji: "🌷"},
      %Emoshi{slug: "hyacinth", name: "hyacinth", status: :fully_qualified, emoji: "🪻"},
      %Emoshi{slug: "seedling", name: "seedling", status: :fully_qualified, emoji: "🌱"},
      %Emoshi{slug: "potted-plant", name: "potted plant", status: :fully_qualified, emoji: "🪴"},
      %Emoshi{
        slug: "evergreen-tree",
        name: "evergreen tree",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "palm-tree", name: "palm tree", status: :fully_qualified, emoji: "🌴"},
      %Emoshi{slug: "cactus", name: "cactus", status: :fully_qualified, emoji: "🌵"},
      %Emoshi{slug: "sheaf-of-rice", name: "sheaf of rice", status: :fully_qualified, emoji: "🌾"},
      %Emoshi{slug: "herb", name: "herb", status: :fully_qualified, emoji: "🌿"},
      %Emoshi{slug: "shamrock", name: "shamrock", status: :fully_qualified, emoji: "☘️"},
      %Emoshi{
      ...
      %Emoshi{slug: "maple-leaf", name: "maple leaf", status: :fully_qualified, emoji: "🍁"},
      %Emoshi{slug: "fallen-leaf", name: "fallen leaf", status: :fully_qualified, emoji: "🍂"},
      %Emoshi{
      ...
      %Emoshi{slug: "empty-nest", name: "empty nest", status: :fully_qualified, emoji: "🪹"},
      %Emoshi{
        slug: "nest-with-eggs",
        name: "nest with eggs",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "mushroom", name: "mushroom", status: :fully_qualified, emoji: "🍄"},
      %Emoshi{slug: "leafless-tree", name: "leafless tree", status: :fully_qualified, emoji: "🪾"},
      %Emoshi{slug: "grapes", name: "grapes", status: :fully_qualified, emoji: "🍇"},
      %Emoshi{slug: "melon", name: "melon", status: :fully_qualified, emoji: "🍈"},
      %Emoshi{slug: "watermelon", name: "watermelon", status: :fully_qualified, emoji: "🍉"},
      %Emoshi{slug: "tangerine", name: "tangerine", status: :fully_qualified, emoji: "🍊"},
      %Emoshi{slug: "lemon", name: "lemon", status: :fully_qualified, emoji: "🍋"},
      %Emoshi{slug: "lime", name: "lime", status: :fully_qualified, emoji: "🍋‍🟩"},
      %Emoshi{slug: "banana", name: "banana", status: :fully_qualified, emoji: "🍌"},
      %Emoshi{slug: "pineapple", name: "pineapple", status: :fully_qualified, emoji: "🍍"},
      %Emoshi{slug: "mango", name: "mango", status: :fully_qualified, emoji: "🥭"},
      %Emoshi{slug: "red-apple", name: "red apple", status: :fully_qualified, emoji: "🍎"},
      %Emoshi{slug: "green-apple", name: "green apple", status: :fully_qualified, emoji: "🍏"},
      %Emoshi{slug: "pear", name: "pear", status: :fully_qualified, emoji: "🍐"},
      %Emoshi{slug: "peach", name: "peach", status: :fully_qualified, emoji: "🍑"},
      %Emoshi{slug: "cherries", name: "cherries", status: :fully_qualified, emoji: "🍒"},
      %Emoshi{slug: "strawberry", name: "strawberry", status: :fully_qualified, emoji: "🍓"},
      %Emoshi{slug: "blueberries", name: "blueberries", status: :fully_qualified, emoji: "🫐"},
      %Emoshi{slug: "kiwi-fruit", name: "kiwi fruit", status: :fully_qualified, emoji: "🥝"},
      %Emoshi{slug: "tomato", name: "tomato", status: :fully_qualified, emoji: "🍅"},
      %Emoshi{slug: "olive", name: "olive", status: :fully_qualified, emoji: "🫒"},
      %Emoshi{slug: "coconut", name: "coconut", status: :fully_qualified, emoji: "🥥"},
      %Emoshi{slug: "avocado", name: "avocado", status: :fully_qualified, emoji: "🥑"},
      %Emoshi{slug: "eggplant", name: "eggplant", status: :fully_qualified, emoji: "🍆"},
      %Emoshi{slug: "potato", name: "potato", status: :fully_qualified, emoji: "🥔"},
      %Emoshi{slug: "carrot", name: "carrot", status: :fully_qualified, emoji: "🥕"},
      %Emoshi{slug: "ear-of-corn", name: "ear of corn", status: :fully_qualified, emoji: "🌽"},
      %Emoshi{slug: "hot-pepper", name: "hot pepper", status: :fully_qualified, emoji: "🌶️"},
      %Emoshi{slug: "bell-pepper", name: "bell pepper", status: :fully_qualified, emoji: "🫑"},
      %Emoshi{slug: "cucumber", name: "cucumber", status: :fully_qualified, emoji: "🥒"},
      %Emoshi{slug: "leafy-green", name: "leafy green", status: :fully_qualified, emoji: "🥬"},
      %Emoshi{slug: "broccoli", name: "broccoli", status: :fully_qualified, emoji: "🥦"},
      %Emoshi{slug: "garlic", name: "garlic", status: :fully_qualified, emoji: "🧄"},
      %Emoshi{slug: "onion", name: "onion", status: :fully_qualified, emoji: "🧅"},
      %Emoshi{slug: "peanuts", name: "peanuts", status: :fully_qualified, emoji: "🥜"},
      %Emoshi{slug: "beans", name: "beans", status: :fully_qualified, emoji: "🫘"},
      %Emoshi{slug: "chestnut", name: "chestnut", status: :fully_qualified, emoji: "🌰"},
      %Emoshi{slug: "ginger-root", name: "ginger root", status: :fully_qualified, emoji: "🫚"},
      %Emoshi{slug: "pea-pod", name: "pea pod", status: :fully_qualified, emoji: "🫛"},
      %Emoshi{
        slug: "brown-mushroom",
        name: "brown mushroom",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "bread", name: "bread", status: :fully_qualified, emoji: "🍞"},
      %Emoshi{slug: "croissant", name: "croissant", status: :fully_qualified, emoji: "🥐"},
      %Emoshi{
        slug: "baguette-bread",
        name: "baguette bread",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flatbread", name: "flatbread", status: :fully_qualified, emoji: "🫓"},
      %Emoshi{slug: "pretzel", name: "pretzel", status: :fully_qualified, emoji: "🥨"},
      %Emoshi{slug: "bagel", name: "bagel", status: :fully_qualified, emoji: "🥯"},
      %Emoshi{slug: "pancakes", name: "pancakes", status: :fully_qualified, emoji: "🥞"},
      %Emoshi{slug: "waffle", name: "waffle", status: :fully_qualified, emoji: "🧇"},
      %Emoshi{slug: "cheese-wedge", name: "cheese wedge", status: :fully_qualified, emoji: "🧀"},
      %Emoshi{slug: "meat-on-bone", name: "meat on bone", status: :fully_qualified, emoji: "🍖"},
      %Emoshi{slug: "poultry-leg", name: "poultry leg", status: :fully_qualified, emoji: "🍗"},
      %Emoshi{slug: "cut-of-meat", name: "cut of meat", status: :fully_qualified, emoji: "🥩"},
      %Emoshi{slug: "bacon", name: "bacon", status: :fully_qualified, emoji: "🥓"},
      %Emoshi{slug: "hamburger", name: "hamburger", status: :fully_qualified, emoji: "🍔"},
      %Emoshi{slug: "french-fries", name: "french fries", status: :fully_qualified, emoji: "🍟"},
      %Emoshi{slug: "pizza", name: "pizza", status: :fully_qualified, emoji: "🍕"},
      %Emoshi{slug: "hot-dog", name: "hot dog", status: :fully_qualified, emoji: "🌭"},
      %Emoshi{slug: "sandwich", name: "sandwich", status: :fully_qualified, emoji: "🥪"},
      %Emoshi{slug: "taco", name: "taco", status: :fully_qualified, emoji: "🌮"},
      %Emoshi{slug: "burrito", name: "burrito", status: :fully_qualified, emoji: "🌯"},
      %Emoshi{slug: "tamale", name: "tamale", status: :fully_qualified, emoji: "🫔"},
      %Emoshi{
      ...
      %Emoshi{slug: "falafel", name: "falafel", status: :fully_qualified, emoji: "🧆"},
      %Emoshi{slug: "egg", name: "egg", status: :fully_qualified, emoji: "🥚"},
      %Emoshi{slug: "cooking", name: "cooking", status: :fully_qualified, emoji: "🍳"},
      %Emoshi{
      ...
      %Emoshi{slug: "pot-of-food", name: "pot of food", status: :fully_qualified, emoji: "🍲"},
      %Emoshi{slug: "fondue", name: "fondue", status: :fully_qualified, emoji: "🫕"},
      %Emoshi{
      ...
      %Emoshi{slug: "green-salad", name: "green salad", status: :fully_qualified, emoji: "🥗"},
      %Emoshi{slug: "popcorn", name: "popcorn", status: :fully_qualified, emoji: "🍿"},
      %Emoshi{slug: "butter", name: "butter", status: :fully_qualified, emoji: "🧈"},
      %Emoshi{slug: "salt", name: "salt", status: :fully_qualified, emoji: "🧂"},
      %Emoshi{slug: "canned-food", name: "canned food", status: :fully_qualified, emoji: "🥫"},
      %Emoshi{slug: "bento-box", name: "bento box", status: :fully_qualified, emoji: "🍱"},
      %Emoshi{slug: "rice-cracker", name: "rice cracker", status: :fully_qualified, emoji: "🍘"},
      %Emoshi{slug: "rice-ball", name: "rice ball", status: :fully_qualified, emoji: "🍙"},
      %Emoshi{slug: "cooked-rice", name: "cooked rice", status: :fully_qualified, emoji: "🍚"},
      %Emoshi{slug: "curry-rice", name: "curry rice", status: :fully_qualified, emoji: "🍛"},
      %Emoshi{slug: "steaming-bowl", name: "steaming bowl", status: :fully_qualified, emoji: "🍜"},
      %Emoshi{slug: "spaghetti", name: "spaghetti", status: :fully_qualified, emoji: "🍝"},
      %Emoshi{
      ...
      %Emoshi{slug: "oden", name: "oden", status: :fully_qualified, emoji: "🍢"},
      %Emoshi{slug: "sushi", name: "sushi", status: :fully_qualified, emoji: "🍣"},
      %Emoshi{slug: "fried-shrimp", name: "fried shrimp", status: :fully_qualified, emoji: "🍤"},
      %Emoshi{
      ...
      %Emoshi{slug: "moon-cake", name: "moon cake", status: :fully_qualified, emoji: "🥮"},
      %Emoshi{slug: "dango", name: "dango", status: :fully_qualified, emoji: "🍡"},
      %Emoshi{slug: "dumpling", name: "dumpling", status: :fully_qualified, emoji: "🥟"},
      %Emoshi{
        slug: "fortune-cookie",
        name: "fortune cookie",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "takeout-box", name: "takeout box", status: :fully_qualified, emoji: "🥡"},
      %Emoshi{
        slug: "soft-ice-cream",
        name: "soft ice cream",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "shaved-ice", name: "shaved ice", status: :fully_qualified, emoji: "🍧"},
      %Emoshi{slug: "ice-cream", name: "ice cream", status: :fully_qualified, emoji: "🍨"},
      %Emoshi{slug: "doughnut", name: "doughnut", status: :fully_qualified, emoji: "🍩"},
      %Emoshi{slug: "cookie", name: "cookie", status: :fully_qualified, emoji: "🍪"},
      %Emoshi{slug: "birthday-cake", name: "birthday cake", status: :fully_qualified, emoji: "🎂"},
      %Emoshi{slug: "shortcake", name: "shortcake", status: :fully_qualified, emoji: "🍰"},
      %Emoshi{slug: "cupcake", name: "cupcake", status: :fully_qualified, emoji: "🧁"},
      %Emoshi{slug: "pie", name: "pie", status: :fully_qualified, emoji: "🥧"},
      %Emoshi{slug: "chocolate-bar", name: "chocolate bar", status: :fully_qualified, emoji: "🍫"},
      %Emoshi{slug: "candy", name: "candy", status: :fully_qualified, emoji: "🍬"},
      %Emoshi{slug: "lollipop", name: "lollipop", status: :fully_qualified, emoji: "🍭"},
      %Emoshi{slug: "custard", name: "custard", status: :fully_qualified, emoji: "🍮"},
      %Emoshi{slug: "honey-pot", name: "honey pot", status: :fully_qualified, emoji: "🍯"},
      %Emoshi{slug: "baby-bottle", name: "baby bottle", status: :fully_qualified, emoji: "🍼"},
      %Emoshi{slug: "glass-of-milk", name: "glass of milk", status: :fully_qualified, emoji: "🥛"},
      %Emoshi{slug: "hot-beverage", name: "hot beverage", status: :fully_qualified, emoji: "☕"},
      %Emoshi{slug: "teapot", name: "teapot", status: :fully_qualified, emoji: "🫖"},
      %Emoshi{
      ...
      %Emoshi{slug: "sake", name: "sake", status: :fully_qualified, emoji: "🍶"},
      %Emoshi{
      ...
      %Emoshi{slug: "wine-glass", name: "wine glass", status: :fully_qualified, emoji: "🍷"},
      %Emoshi{
        slug: "cocktail-glass",
        name: "cocktail glass",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "beer-mug", name: "beer mug", status: :fully_qualified, emoji: "🍺"},
      %Emoshi{
      ...
      %Emoshi{slug: "tumbler-glass", name: "tumbler glass", status: :fully_qualified, emoji: "🥃"},
      %Emoshi{
        slug: "pouring-liquid",
        name: "pouring liquid",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "bubble-tea", name: "bubble tea", status: :fully_qualified, emoji: "🧋"},
      %Emoshi{slug: "beverage-box", name: "beverage box", status: :fully_qualified, emoji: "🧃"},
      %Emoshi{slug: "mate", name: "mate", status: :fully_qualified, emoji: "🧉"},
      %Emoshi{slug: "ice", name: "ice", status: :fully_qualified, emoji: "🧊"},
      %Emoshi{slug: "chopsticks", name: "chopsticks", status: :fully_qualified, emoji: "🥢"},
      %Emoshi{
      ...
      %Emoshi{slug: "spoon", name: "spoon", status: :fully_qualified, emoji: "🥄"},
      %Emoshi{slug: "kitchen-knife", name: "kitchen knife", status: :fully_qualified, emoji: "🔪"},
      %Emoshi{slug: "jar", name: "jar", status: :fully_qualified, emoji: "🫙"},
      %Emoshi{slug: "amphora", name: "amphora", status: :fully_qualified, emoji: "🏺"},
      %Emoshi{
      ...
      %Emoshi{slug: "world-map", name: "world map", status: :fully_qualified, emoji: "🗺️"},
      %Emoshi{slug: "map-of-japan", name: "map of Japan", status: :fully_qualified, emoji: "🗾"},
      %Emoshi{slug: "compass", name: "compass", status: :fully_qualified, emoji: "🧭"},
      %Emoshi{
      ...
      %Emoshi{slug: "mountain", name: "mountain", status: :fully_qualified, emoji: "⛰️"},
      %Emoshi{slug: "volcano", name: "volcano", status: :fully_qualified, emoji: "🌋"},
      %Emoshi{slug: "mount-fuji", name: "mount fuji", status: :fully_qualified, emoji: "🗻"},
      %Emoshi{slug: "camping", name: "camping", status: :fully_qualified, emoji: "🏕️"},
      %Emoshi{
      ...
      %Emoshi{slug: "desert", name: "desert", status: :fully_qualified, emoji: "🏜️"},
      %Emoshi{slug: "desert-island", name: "desert island", status: :fully_qualified, emoji: "🏝️"},
      %Emoshi{slug: "national-park", name: "national park", status: :fully_qualified, emoji: "🏞️"},
      %Emoshi{slug: "stadium", name: "stadium", status: :fully_qualified, emoji: "🏟️"},
      %Emoshi{
      ...
      %Emoshi{slug: "brick", name: "brick", status: :fully_qualified, emoji: "🧱"},
      %Emoshi{slug: "rock", name: "rock", status: :fully_qualified, emoji: "🪨"},
      %Emoshi{slug: "wood", name: "wood", status: :fully_qualified, emoji: "🪵"},
      %Emoshi{slug: "hut", name: "hut", status: :fully_qualified, emoji: "🛖"},
      %Emoshi{slug: "houses", name: "houses", status: :fully_qualified, emoji: "🏘️"},
      %Emoshi{
        slug: "derelict-house",
        name: "derelict house",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "house", name: "house", status: :fully_qualified, emoji: "🏠"},
      %Emoshi{
      ...
      %Emoshi{slug: "post-office", name: "post office", status: :fully_qualified, emoji: "🏤"},
      %Emoshi{slug: "hospital", name: "hospital", status: :fully_qualified, emoji: "🏥"},
      %Emoshi{slug: "bank", name: "bank", status: :fully_qualified, emoji: "🏦"},
      %Emoshi{slug: "hotel", name: "hotel", status: :fully_qualified, emoji: "🏨"},
      %Emoshi{slug: "love-hotel", name: "love hotel", status: :fully_qualified, emoji: "🏩"},
      %Emoshi{
      ...
      %Emoshi{slug: "school", name: "school", status: :fully_qualified, emoji: "🏫"},
      %Emoshi{
      ...
      %Emoshi{slug: "factory", name: "factory", status: :fully_qualified, emoji: "🏭"},
      %Emoshi{
      ...
      %Emoshi{slug: "castle", name: "castle", status: :fully_qualified, emoji: "🏰"},
      %Emoshi{slug: "wedding", name: "wedding", status: :fully_qualified, emoji: "💒"},
      %Emoshi{slug: "tokyo-tower", name: "Tokyo tower", status: :fully_qualified, emoji: "🗼"},
      %Emoshi{
      ...
      %Emoshi{slug: "church", name: "church", status: :fully_qualified, emoji: "⛪"},
      %Emoshi{slug: "mosque", name: "mosque", status: :fully_qualified, emoji: "🕌"},
      %Emoshi{slug: "hindu-temple", name: "hindu temple", status: :fully_qualified, emoji: "🛕"},
      %Emoshi{slug: "synagogue", name: "synagogue", status: :fully_qualified, emoji: "🕍"},
      %Emoshi{slug: "shinto-shrine", name: "shinto shrine", status: :fully_qualified, emoji: "⛩️"},
      %Emoshi{slug: "kaaba", name: "kaaba", status: :fully_qualified, emoji: "🕋"},
      %Emoshi{slug: "fountain", name: "fountain", status: :fully_qualified, emoji: "⛲"},
      %Emoshi{slug: "tent", name: "tent", status: :fully_qualified, emoji: "⛺"},
      %Emoshi{slug: "foggy", name: "foggy", status: :fully_qualified, emoji: "🌁"},
      %Emoshi{
      ...
      %Emoshi{slug: "cityscape", name: "cityscape", status: :fully_qualified, emoji: "🏙️"},
      %Emoshi{
      ...
      %Emoshi{slug: "sunrise", name: "sunrise", status: :fully_qualified, emoji: "🌅"},
      %Emoshi{
      ...
      %Emoshi{slug: "sunset", name: "sunset", status: :fully_qualified, emoji: "🌇"},
      %Emoshi{
      ...
      %Emoshi{slug: "hot-springs", name: "hot springs", status: :fully_qualified, emoji: "♨️"},
      %Emoshi{
        slug: "carousel-horse",
        name: "carousel horse",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "ferris-wheel", name: "ferris wheel", status: :fully_qualified, emoji: "🎡"},
      %Emoshi{
        slug: "roller-coaster",
        name: "roller coaster",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "barber-pole", name: "barber pole", status: :fully_qualified, emoji: "💈"},
      %Emoshi{slug: "circus-tent", name: "circus tent", status: :fully_qualified, emoji: "🎪"},
      %Emoshi{slug: "locomotive", name: "locomotive", status: :fully_qualified, emoji: "🚂"},
      %Emoshi{slug: "railway-car", name: "railway car", status: :fully_qualified, emoji: "🚃"},
      %Emoshi{
      ...
      %Emoshi{slug: "bullet-train", name: "bullet train", status: :fully_qualified, emoji: "🚅"},
      %Emoshi{slug: "train", name: "train", status: :fully_qualified, emoji: "🚆"},
      %Emoshi{slug: "metro", name: "metro", status: :fully_qualified, emoji: "🚇"},
      %Emoshi{slug: "light-rail", name: "light rail", status: :fully_qualified, emoji: "🚈"},
      %Emoshi{slug: "station", name: "station", status: :fully_qualified, emoji: "🚉"},
      %Emoshi{slug: "tram", name: "tram", status: :fully_qualified, emoji: "🚊"},
      %Emoshi{slug: "monorail", name: "monorail", status: :fully_qualified, emoji: "🚝"},
      %Emoshi{
      ...
      %Emoshi{slug: "tram-car", name: "tram car", status: :fully_qualified, emoji: "🚋"},
      %Emoshi{slug: "bus", name: "bus", status: :fully_qualified, emoji: "🚌"},
      %Emoshi{slug: "oncoming-bus", name: "oncoming bus", status: :fully_qualified, emoji: "🚍"},
      %Emoshi{slug: "trolleybus", name: "trolleybus", status: :fully_qualified, emoji: "🚎"},
      %Emoshi{slug: "minibus", name: "minibus", status: :fully_qualified, emoji: "🚐"},
      %Emoshi{slug: "ambulance", name: "ambulance", status: :fully_qualified, emoji: "🚑"},
      %Emoshi{slug: "fire-engine", name: "fire engine", status: :fully_qualified, emoji: "🚒"},
      %Emoshi{slug: "police-car", name: "police car", status: :fully_qualified, emoji: "🚓"},
      %Emoshi{
      ...
      %Emoshi{slug: "taxi", name: "taxi", status: :fully_qualified, emoji: "🚕"},
      %Emoshi{slug: "oncoming-taxi", name: "oncoming taxi", status: :fully_qualified, emoji: "🚖"},
      %Emoshi{slug: "automobile", name: "automobile", status: :fully_qualified, emoji: "🚗"},
      %Emoshi{
      ...
      %Emoshi{slug: "pickup-truck", name: "pickup truck", status: :fully_qualified, emoji: "🛻"},
      %Emoshi{
        slug: "delivery-truck",
        name: "delivery truck",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "tractor", name: "tractor", status: :fully_qualified, emoji: "🚜"},
      %Emoshi{slug: "racing-car", name: "racing car", status: :fully_qualified, emoji: "🏎️"},
      %Emoshi{slug: "motorcycle", name: "motorcycle", status: :fully_qualified, emoji: "🏍️"},
      %Emoshi{slug: "motor-scooter", name: "motor scooter", status: :fully_qualified, emoji: "🛵"},
      %Emoshi{
      ...
      %Emoshi{slug: "auto-rickshaw", name: "auto rickshaw", status: :fully_qualified, emoji: "🛺"},
      %Emoshi{slug: "bicycle", name: "bicycle", status: :fully_qualified, emoji: "🚲"},
      %Emoshi{slug: "kick-scooter", name: "kick scooter", status: :fully_qualified, emoji: "🛴"},
      %Emoshi{slug: "skateboard", name: "skateboard", status: :fully_qualified, emoji: "🛹"},
      %Emoshi{slug: "roller-skate", name: "roller skate", status: :fully_qualified, emoji: "🛼"},
      %Emoshi{slug: "bus-stop", name: "bus stop", status: :fully_qualified, emoji: "🚏"},
      %Emoshi{slug: "motorway", name: "motorway", status: :fully_qualified, emoji: "🛣️"},
      %Emoshi{slug: "railway-track", name: "railway track", status: :fully_qualified, emoji: "🛤️"},
      %Emoshi{slug: "oil-drum", name: "oil drum", status: :fully_qualified, emoji: "🛢️"},
      %Emoshi{slug: "fuel-pump", name: "fuel pump", status: :fully_qualified, emoji: "⛽"},
      %Emoshi{slug: "wheel", name: "wheel", status: :fully_qualified, emoji: "🛞"},
      %Emoshi{
      ...
      %Emoshi{slug: "stop-sign", name: "stop sign", status: :fully_qualified, emoji: "🛑"},
      %Emoshi{slug: "construction", name: "construction", status: :fully_qualified, emoji: "🚧"},
      %Emoshi{slug: "anchor", name: "anchor", status: :fully_qualified, emoji: "⚓"},
      %Emoshi{slug: "ring-buoy", name: "ring buoy", status: :fully_qualified, emoji: "🛟"},
      %Emoshi{slug: "sailboat", name: "sailboat", status: :fully_qualified, emoji: "⛵"},
      %Emoshi{slug: "canoe", name: "canoe", status: :fully_qualified, emoji: "🛶"},
      %Emoshi{slug: "speedboat", name: "speedboat", status: :fully_qualified, emoji: "🚤"},
      %Emoshi{
        slug: "passenger-ship",
        name: "passenger ship",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "ferry", name: "ferry", status: :fully_qualified, emoji: "⛴️"},
      %Emoshi{slug: "motor-boat", name: "motor boat", status: :fully_qualified, emoji: "🛥️"},
      %Emoshi{slug: "ship", name: "ship", status: :fully_qualified, emoji: "🚢"},
      %Emoshi{slug: "airplane", name: "airplane", status: :fully_qualified, emoji: "✈️"},
      %Emoshi{
        slug: "small-airplane",
        name: "small airplane",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "parachute", name: "parachute", status: :fully_qualified, emoji: "🪂"},
      %Emoshi{slug: "seat", name: "seat", status: :fully_qualified, emoji: "💺"},
      %Emoshi{slug: "helicopter", name: "helicopter", status: :fully_qualified, emoji: "🚁"},
      %Emoshi{
      ...
      %Emoshi{slug: "satellite", name: "satellite", status: :fully_qualified, emoji: "🛰️"},
      %Emoshi{slug: "rocket", name: "rocket", status: :fully_qualified, emoji: "🚀"},
      %Emoshi{slug: "flying-saucer", name: "flying saucer", status: :fully_qualified, emoji: "🛸"},
      %Emoshi{slug: "bellhop-bell", name: "bellhop bell", status: :fully_qualified, emoji: "🛎️"},
      %Emoshi{slug: "luggage", name: "luggage", status: :fully_qualified, emoji: "🧳"},
      %Emoshi{
        slug: "hourglass-done",
        name: "hourglass done",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "watch", name: "watch", status: :fully_qualified, emoji: "⌚"},
      %Emoshi{slug: "alarm-clock", name: "alarm clock", status: :fully_qualified, emoji: "⏰"},
      %Emoshi{slug: "stopwatch", name: "stopwatch", status: :fully_qualified, emoji: "⏱️"},
      %Emoshi{slug: "timer-clock", name: "timer clock", status: :fully_qualified, emoji: "⏲️"},
      %Emoshi{
      ...
      %Emoshi{slug: "twelve-thirty", name: "twelve-thirty", status: :fully_qualified, emoji: "🕧"},
      %Emoshi{slug: "one-o-clock", name: "one o’clock", status: :fully_qualified, emoji: "🕐"},
      %Emoshi{slug: "one-thirty", name: "one-thirty", status: :fully_qualified, emoji: "🕜"},
      %Emoshi{slug: "two-o-clock", name: "two o’clock", status: :fully_qualified, emoji: "🕑"},
      %Emoshi{slug: "two-thirty", name: "two-thirty", status: :fully_qualified, emoji: "🕝"},
      %Emoshi{slug: "three-o-clock", name: "three o’clock", status: :fully_qualified, emoji: "🕒"},
      %Emoshi{slug: "three-thirty", name: "three-thirty", status: :fully_qualified, emoji: "🕞"},
      %Emoshi{slug: "four-o-clock", name: "four o’clock", status: :fully_qualified, emoji: "🕓"},
      %Emoshi{slug: "four-thirty", name: "four-thirty", status: :fully_qualified, emoji: "🕟"},
      %Emoshi{slug: "five-o-clock", name: "five o’clock", status: :fully_qualified, emoji: "🕔"},
      %Emoshi{slug: "five-thirty", name: "five-thirty", status: :fully_qualified, emoji: "🕠"},
      %Emoshi{slug: "six-o-clock", name: "six o’clock", status: :fully_qualified, emoji: "🕕"},
      %Emoshi{slug: "six-thirty", name: "six-thirty", status: :fully_qualified, emoji: "🕡"},
      %Emoshi{slug: "seven-o-clock", name: "seven o’clock", status: :fully_qualified, emoji: "🕖"},
      %Emoshi{slug: "seven-thirty", name: "seven-thirty", status: :fully_qualified, emoji: "🕢"},
      %Emoshi{slug: "eight-o-clock", name: "eight o’clock", status: :fully_qualified, emoji: "🕗"},
      %Emoshi{slug: "eight-thirty", name: "eight-thirty", status: :fully_qualified, emoji: "🕣"},
      %Emoshi{slug: "nine-o-clock", name: "nine o’clock", status: :fully_qualified, emoji: "🕘"},
      %Emoshi{slug: "nine-thirty", name: "nine-thirty", status: :fully_qualified, emoji: "🕤"},
      %Emoshi{slug: "ten-o-clock", name: "ten o’clock", status: :fully_qualified, emoji: "🕙"},
      %Emoshi{slug: "ten-thirty", name: "ten-thirty", status: :fully_qualified, emoji: "🕥"},
      %Emoshi{
        slug: "eleven-o-clock",
        name: "eleven o’clock",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "eleven-thirty", name: "eleven-thirty", status: :fully_qualified, emoji: "🕦"},
      %Emoshi{slug: "new-moon", name: "new moon", status: :fully_qualified, emoji: "🌑"},
      %Emoshi{
      ...
      %Emoshi{slug: "full-moon", name: "full moon", status: :fully_qualified, emoji: "🌕"},
      %Emoshi{
      ...
      %Emoshi{slug: "crescent-moon", name: "crescent moon", status: :fully_qualified, emoji: "🌙"},
      %Emoshi{slug: "new-moon-face", name: "new moon face", status: :fully_qualified, emoji: "🌚"},
      %Emoshi{
      ...
      %Emoshi{slug: "thermometer", name: "thermometer", status: :fully_qualified, emoji: "🌡️"},
      %Emoshi{slug: "sun", name: "sun", status: :fully_qualified, emoji: "☀️"},
      %Emoshi{
        slug: "full-moon-face",
        name: "full moon face",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "sun-with-face", name: "sun with face", status: :fully_qualified, emoji: "🌞"},
      %Emoshi{slug: "ringed-planet", name: "ringed planet", status: :fully_qualified, emoji: "🪐"},
      %Emoshi{slug: "star", name: "star", status: :fully_qualified, emoji: "⭐"},
      %Emoshi{slug: "glowing-star", name: "glowing star", status: :fully_qualified, emoji: "🌟"},
      %Emoshi{slug: "shooting-star", name: "shooting star", status: :fully_qualified, emoji: "🌠"},
      %Emoshi{slug: "milky-way", name: "milky way", status: :fully_qualified, emoji: "🌌"},
      %Emoshi{slug: "cloud", name: "cloud", status: :fully_qualified, emoji: "☁️"},
      %Emoshi{
      ...
      %Emoshi{slug: "tornado", name: "tornado", status: :fully_qualified, emoji: "🌪️"},
      %Emoshi{slug: "fog", name: "fog", status: :fully_qualified, emoji: "🌫️"},
      %Emoshi{slug: "wind-face", name: "wind face", status: :fully_qualified, emoji: "🌬️"},
      %Emoshi{slug: "cyclone", name: "cyclone", status: :fully_qualified, emoji: "🌀"},
      %Emoshi{slug: "rainbow", name: "rainbow", status: :fully_qualified, emoji: "🌈"},
      %Emoshi{
      ...
      %Emoshi{slug: "umbrella", name: "umbrella", status: :fully_qualified, emoji: "☂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "high-voltage", name: "high voltage", status: :fully_qualified, emoji: "⚡"},
      %Emoshi{slug: "snowflake", name: "snowflake", status: :fully_qualified, emoji: "❄️"},
      %Emoshi{slug: "snowman", name: "snowman", status: :fully_qualified, emoji: "☃️"},
      %Emoshi{
      ...
      %Emoshi{slug: "comet", name: "comet", status: :fully_qualified, emoji: "☄️"},
      %Emoshi{slug: "fire", name: "fire", status: :fully_qualified, emoji: "🔥"},
      %Emoshi{slug: "droplet", name: "droplet", status: :fully_qualified, emoji: "💧"},
      %Emoshi{slug: "water-wave", name: "water wave", status: :fully_qualified, emoji: "🌊"},
      %Emoshi{
        slug: "jack-o-lantern",
        name: "jack-o-lantern",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "fireworks", name: "fireworks", status: :fully_qualified, emoji: "🎆"},
      %Emoshi{slug: "sparkler", name: "sparkler", status: :fully_qualified, emoji: "🎇"},
      %Emoshi{slug: "firecracker", name: "firecracker", status: :fully_qualified, emoji: "🧨"},
      %Emoshi{slug: "sparkles", name: "sparkles", status: :fully_qualified, emoji: "✨"},
      %Emoshi{slug: "balloon", name: "balloon", status: :fully_qualified, emoji: "🎈"},
      %Emoshi{slug: "party-popper", name: "party popper", status: :fully_qualified, emoji: "🎉"},
      %Emoshi{slug: "confetti-ball", name: "confetti ball", status: :fully_qualified, emoji: "🎊"},
      %Emoshi{slug: "tanabata-tree", name: "tanabata tree", status: :fully_qualified, emoji: "🎋"},
      %Emoshi{
      ...
      %Emoshi{slug: "carp-streamer", name: "carp streamer", status: :fully_qualified, emoji: "🎏"},
      %Emoshi{slug: "wind-chime", name: "wind chime", status: :fully_qualified, emoji: "🎐"},
      %Emoshi{
      ...
      %Emoshi{slug: "red-envelope", name: "red envelope", status: :fully_qualified, emoji: "🧧"},
      %Emoshi{slug: "ribbon", name: "ribbon", status: :fully_qualified, emoji: "🎀"},
      %Emoshi{slug: "wrapped-gift", name: "wrapped gift", status: :fully_qualified, emoji: "🎁"},
      %Emoshi{
      ...
      %Emoshi{slug: "ticket", name: "ticket", status: :fully_qualified, emoji: "🎫"},
      %Emoshi{
        slug: "military-medal",
        name: "military medal",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "trophy", name: "trophy", status: :fully_qualified, emoji: "🏆"},
      %Emoshi{slug: "sports-medal", name: "sports medal", status: :fully_qualified, emoji: "🏅"},
      %Emoshi{
      ...
      %Emoshi{slug: "soccer-ball", name: "soccer ball", status: :fully_qualified, emoji: "⚽"},
      %Emoshi{slug: "baseball", name: "baseball", status: :fully_qualified, emoji: "⚾"},
      %Emoshi{slug: "softball", name: "softball", status: :fully_qualified, emoji: "🥎"},
      %Emoshi{slug: "basketball", name: "basketball", status: :fully_qualified, emoji: "🏀"},
      %Emoshi{slug: "volleyball", name: "volleyball", status: :fully_qualified, emoji: "🏐"},
      %Emoshi{
      ...
      %Emoshi{slug: "tennis", name: "tennis", status: :fully_qualified, emoji: "🎾"},
      %Emoshi{slug: "flying-disc", name: "flying disc", status: :fully_qualified, emoji: "🥏"},
      %Emoshi{slug: "bowling", name: "bowling", status: :fully_qualified, emoji: "🎳"},
      %Emoshi{slug: "cricket-game", name: "cricket game", status: :fully_qualified, emoji: "🏏"},
      %Emoshi{slug: "field-hockey", name: "field hockey", status: :fully_qualified, emoji: "🏑"},
      %Emoshi{slug: "ice-hockey", name: "ice hockey", status: :fully_qualified, emoji: "🏒"},
      %Emoshi{slug: "lacrosse", name: "lacrosse", status: :fully_qualified, emoji: "🥍"},
      %Emoshi{slug: "ping-pong", name: "ping pong", status: :fully_qualified, emoji: "🏓"},
      %Emoshi{slug: "badminton", name: "badminton", status: :fully_qualified, emoji: "🏸"},
      %Emoshi{slug: "boxing-glove", name: "boxing glove", status: :fully_qualified, emoji: "🥊"},
      %Emoshi{
      ...
      %Emoshi{slug: "goal-net", name: "goal net", status: :fully_qualified, emoji: "🥅"},
      %Emoshi{slug: "flag-in-hole", name: "flag in hole", status: :fully_qualified, emoji: "⛳"},
      %Emoshi{slug: "ice-skate", name: "ice skate", status: :fully_qualified, emoji: "⛸️"},
      %Emoshi{slug: "fishing-pole", name: "fishing pole", status: :fully_qualified, emoji: "🎣"},
      %Emoshi{slug: "diving-mask", name: "diving mask", status: :fully_qualified, emoji: "🤿"},
      %Emoshi{slug: "running-shirt", name: "running shirt", status: :fully_qualified, emoji: "🎽"},
      %Emoshi{slug: "skis", name: "skis", status: :fully_qualified, emoji: "🎿"},
      %Emoshi{slug: "sled", name: "sled", status: :fully_qualified, emoji: "🛷"},
      %Emoshi{slug: "curling-stone", name: "curling stone", status: :fully_qualified, emoji: "🥌"},
      %Emoshi{slug: "bullseye", name: "bullseye", status: :fully_qualified, emoji: "🎯"},
      %Emoshi{slug: "yo-yo", name: "yo-yo", status: :fully_qualified, emoji: "🪀"},
      %Emoshi{slug: "kite", name: "kite", status: :fully_qualified, emoji: "🪁"},
      %Emoshi{slug: "water-pistol", name: "water pistol", status: :fully_qualified, emoji: "🔫"},
      %Emoshi{slug: "pool-8-ball", name: "pool 8 ball", status: :fully_qualified, emoji: "🎱"},
      %Emoshi{slug: "crystal-ball", name: "crystal ball", status: :fully_qualified, emoji: "🔮"},
      %Emoshi{slug: "magic-wand", name: "magic wand", status: :fully_qualified, emoji: "🪄"},
      %Emoshi{slug: "video-game", name: "video game", status: :fully_qualified, emoji: "🎮"},
      %Emoshi{slug: "joystick", name: "joystick", status: :fully_qualified, emoji: "🕹️"},
      %Emoshi{slug: "slot-machine", name: "slot machine", status: :fully_qualified, emoji: "🎰"},
      %Emoshi{slug: "game-die", name: "game die", status: :fully_qualified, emoji: "🎲"},
      %Emoshi{slug: "puzzle-piece", name: "puzzle piece", status: :fully_qualified, emoji: "🧩"},
      %Emoshi{slug: "teddy-bear", name: "teddy bear", status: :fully_qualified, emoji: "🧸"},
      %Emoshi{slug: "pin-ata", name: "piñata", status: :fully_qualified, emoji: "🪅"},
      %Emoshi{slug: "mirror-ball", name: "mirror ball", status: :fully_qualified, emoji: "🪩"},
      %Emoshi{slug: "nesting-dolls", name: "nesting dolls", status: :fully_qualified, emoji: "🪆"},
      %Emoshi{slug: "spade-suit", name: "spade suit", status: :fully_qualified, emoji: "♠️"},
      %Emoshi{slug: "heart-suit", name: "heart suit", status: :fully_qualified, emoji: "♥️"},
      %Emoshi{slug: "diamond-suit", name: "diamond suit", status: :fully_qualified, emoji: "♦️"},
      %Emoshi{slug: "club-suit", name: "club suit", status: :fully_qualified, emoji: "♣️"},
      %Emoshi{slug: "chess-pawn", name: "chess pawn", status: :fully_qualified, emoji: "♟️"},
      %Emoshi{slug: "joker", name: "joker", status: :fully_qualified, emoji: "🃏"},
      %Emoshi{
      ...
      %Emoshi{slug: "thread", name: "thread", status: :fully_qualified, emoji: "🧵"},
      %Emoshi{slug: "sewing-needle", name: "sewing needle", status: :fully_qualified, emoji: "🪡"},
      %Emoshi{slug: "yarn", name: "yarn", status: :fully_qualified, emoji: "🧶"},
      %Emoshi{slug: "knot", name: "knot", status: :fully_qualified, emoji: "🪢"},
      %Emoshi{slug: "glasses", name: "glasses", status: :fully_qualified, emoji: "👓"},
      %Emoshi{slug: "sunglasses", name: "sunglasses", status: :fully_qualified, emoji: "🕶️"},
      %Emoshi{slug: "goggles", name: "goggles", status: :fully_qualified, emoji: "🥽"},
      %Emoshi{slug: "lab-coat", name: "lab coat", status: :fully_qualified, emoji: "🥼"},
      %Emoshi{slug: "safety-vest", name: "safety vest", status: :fully_qualified, emoji: "🦺"},
      %Emoshi{slug: "necktie", name: "necktie", status: :fully_qualified, emoji: "👔"},
      %Emoshi{slug: "t-shirt", name: "t-shirt", status: :fully_qualified, emoji: "👕"},
      %Emoshi{slug: "jeans", name: "jeans", status: :fully_qualified, emoji: "👖"},
      %Emoshi{slug: "scarf", name: "scarf", status: :fully_qualified, emoji: "🧣"},
      %Emoshi{slug: "gloves", name: "gloves", status: :fully_qualified, emoji: "🧤"},
      %Emoshi{slug: "coat", name: "coat", status: :fully_qualified, emoji: "🧥"},
      %Emoshi{slug: "socks", name: "socks", status: :fully_qualified, emoji: "🧦"},
      %Emoshi{slug: "dress", name: "dress", status: :fully_qualified, emoji: "👗"},
      %Emoshi{slug: "kimono", name: "kimono", status: :fully_qualified, emoji: "👘"},
      %Emoshi{slug: "sari", name: "sari", status: :fully_qualified, emoji: "🥻"},
      %Emoshi{
      ...
      %Emoshi{slug: "briefs", name: "briefs", status: :fully_qualified, emoji: "🩲"},
      %Emoshi{slug: "shorts", name: "shorts", status: :fully_qualified, emoji: "🩳"},
      %Emoshi{slug: "bikini", name: "bikini", status: :fully_qualified, emoji: "👙"},
      %Emoshi{
      ...
      %Emoshi{slug: "purse", name: "purse", status: :fully_qualified, emoji: "👛"},
      %Emoshi{slug: "handbag", name: "handbag", status: :fully_qualified, emoji: "👜"},
      %Emoshi{slug: "clutch-bag", name: "clutch bag", status: :fully_qualified, emoji: "👝"},
      %Emoshi{slug: "shopping-bags", name: "shopping bags", status: :fully_qualified, emoji: "🛍️"},
      %Emoshi{slug: "backpack", name: "backpack", status: :fully_qualified, emoji: "🎒"},
      %Emoshi{slug: "thong-sandal", name: "thong sandal", status: :fully_qualified, emoji: "🩴"},
      %Emoshi{slug: "man-s-shoe", name: "man’s shoe", status: :fully_qualified, emoji: "👞"},
      %Emoshi{slug: "running-shoe", name: "running shoe", status: :fully_qualified, emoji: "👟"},
      %Emoshi{slug: "hiking-boot", name: "hiking boot", status: :fully_qualified, emoji: "🥾"},
      %Emoshi{slug: "flat-shoe", name: "flat shoe", status: :fully_qualified, emoji: "🥿"},
      %Emoshi{
      ...
      %Emoshi{slug: "ballet-shoes", name: "ballet shoes", status: :fully_qualified, emoji: "🩰"},
      %Emoshi{slug: "woman-s-boot", name: "woman’s boot", status: :fully_qualified, emoji: "👢"},
      %Emoshi{slug: "hair-pick", name: "hair pick", status: :fully_qualified, emoji: "🪮"},
      %Emoshi{slug: "crown", name: "crown", status: :fully_qualified, emoji: "👑"},
      %Emoshi{slug: "woman-s-hat", name: "woman’s hat", status: :fully_qualified, emoji: "👒"},
      %Emoshi{slug: "top-hat", name: "top hat", status: :fully_qualified, emoji: "🎩"},
      %Emoshi{
        slug: "graduation-cap",
        name: "graduation cap",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "billed-cap", name: "billed cap", status: :fully_qualified, emoji: "🧢"},
      %Emoshi{
      ...
      %Emoshi{slug: "prayer-beads", name: "prayer beads", status: :fully_qualified, emoji: "📿"},
      %Emoshi{slug: "lipstick", name: "lipstick", status: :fully_qualified, emoji: "💄"},
      %Emoshi{slug: "ring", name: "ring", status: :fully_qualified, emoji: "💍"},
      %Emoshi{slug: "gem-stone", name: "gem stone", status: :fully_qualified, emoji: "💎"},
      %Emoshi{slug: "muted-speaker", name: "muted speaker", status: :fully_qualified, emoji: "🔇"},
      %Emoshi{
      ...
      %Emoshi{slug: "loudspeaker", name: "loudspeaker", status: :fully_qualified, emoji: "📢"},
      %Emoshi{slug: "megaphone", name: "megaphone", status: :fully_qualified, emoji: "📣"},
      %Emoshi{slug: "postal-horn", name: "postal horn", status: :fully_qualified, emoji: "📯"},
      %Emoshi{slug: "bell", name: "bell", status: :fully_qualified, emoji: "🔔"},
      %Emoshi{
      ...
      %Emoshi{slug: "musical-score", name: "musical score", status: :fully_qualified, emoji: "🎼"},
      %Emoshi{slug: "musical-note", name: "musical note", status: :fully_qualified, emoji: "🎵"},
      %Emoshi{slug: "musical-notes", name: "musical notes", status: :fully_qualified, emoji: "🎶"},
      %Emoshi{
      ...
      %Emoshi{slug: "level-slider", name: "level slider", status: :fully_qualified, emoji: "🎚️"},
      %Emoshi{slug: "control-knobs", name: "control knobs", status: :fully_qualified, emoji: "🎛️"},
      %Emoshi{slug: "microphone", name: "microphone", status: :fully_qualified, emoji: "🎤"},
      %Emoshi{slug: "headphone", name: "headphone", status: :fully_qualified, emoji: "🎧"},
      %Emoshi{slug: "radio", name: "radio", status: :fully_qualified, emoji: "📻"},
      %Emoshi{slug: "saxophone", name: "saxophone", status: :fully_qualified, emoji: "🎷"},
      %Emoshi{slug: "accordion", name: "accordion", status: :fully_qualified, emoji: "🪗"},
      %Emoshi{slug: "guitar", name: "guitar", status: :fully_qualified, emoji: "🎸"},
      %Emoshi{
      ...
      %Emoshi{slug: "trumpet", name: "trumpet", status: :fully_qualified, emoji: "🎺"},
      %Emoshi{slug: "violin", name: "violin", status: :fully_qualified, emoji: "🎻"},
      %Emoshi{slug: "banjo", name: "banjo", status: :fully_qualified, emoji: "🪕"},
      %Emoshi{slug: "drum", name: "drum", status: :fully_qualified, emoji: "🥁"},
      %Emoshi{slug: "long-drum", name: "long drum", status: :fully_qualified, emoji: "🪘"},
      %Emoshi{slug: "maracas", name: "maracas", status: :fully_qualified, emoji: "🪇"},
      %Emoshi{slug: "flute", name: "flute", status: :fully_qualified, emoji: "🪈"},
      %Emoshi{slug: "harp", name: "harp", status: :fully_qualified, emoji: "🪉"},
      %Emoshi{slug: "mobile-phone", name: "mobile phone", status: :fully_qualified, emoji: "📱"},
      %Emoshi{
      ...
      %Emoshi{slug: "telephone", name: "telephone", status: :fully_qualified, emoji: "☎️"},
      %Emoshi{
      ...
      %Emoshi{slug: "pager", name: "pager", status: :fully_qualified, emoji: "📟"},
      %Emoshi{slug: "fax-machine", name: "fax machine", status: :fully_qualified, emoji: "📠"},
      %Emoshi{slug: "battery", name: "battery", status: :fully_qualified, emoji: "🔋"},
      %Emoshi{slug: "low-battery", name: "low battery", status: :fully_qualified, emoji: "🪫"},
      %Emoshi{slug: "electric-plug", name: "electric plug", status: :fully_qualified, emoji: "🔌"},
      %Emoshi{slug: "laptop", name: "laptop", status: :fully_qualified, emoji: "💻"},
      %Emoshi{
      ...
      %Emoshi{slug: "printer", name: "printer", status: :fully_qualified, emoji: "🖨️"},
      %Emoshi{slug: "keyboard", name: "keyboard", status: :fully_qualified, emoji: "⌨️"},
      %Emoshi{
        slug: "computer-mouse",
        name: "computer mouse",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "trackball", name: "trackball", status: :fully_qualified, emoji: "🖲️"},
      %Emoshi{slug: "computer-disk", name: "computer disk", status: :fully_qualified, emoji: "💽"},
      %Emoshi{slug: "floppy-disk", name: "floppy disk", status: :fully_qualified, emoji: "💾"},
      %Emoshi{slug: "optical-disk", name: "optical disk", status: :fully_qualified, emoji: "💿"},
      %Emoshi{slug: "dvd", name: "dvd", status: :fully_qualified, emoji: "📀"},
      %Emoshi{slug: "abacus", name: "abacus", status: :fully_qualified, emoji: "🧮"},
      %Emoshi{slug: "movie-camera", name: "movie camera", status: :fully_qualified, emoji: "🎥"},
      %Emoshi{slug: "film-frames", name: "film frames", status: :fully_qualified, emoji: "🎞️"},
      %Emoshi{
        slug: "film-projector",
        name: "film projector",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "clapper-board", name: "clapper board", status: :fully_qualified, emoji: "🎬"},
      %Emoshi{slug: "television", name: "television", status: :fully_qualified, emoji: "📺"},
      %Emoshi{slug: "camera", name: "camera", status: :fully_qualified, emoji: "📷"},
      %Emoshi{
      ...
      %Emoshi{slug: "video-camera", name: "video camera", status: :fully_qualified, emoji: "📹"},
      %Emoshi{slug: "videocassette", name: "videocassette", status: :fully_qualified, emoji: "📼"},
      %Emoshi{
      ...
      %Emoshi{slug: "candle", name: "candle", status: :fully_qualified, emoji: "🕯️"},
      %Emoshi{slug: "light-bulb", name: "light bulb", status: :fully_qualified, emoji: "💡"},
      %Emoshi{slug: "flashlight", name: "flashlight", status: :fully_qualified, emoji: "🔦"},
      %Emoshi{
      ...
      %Emoshi{slug: "diya-lamp", name: "diya lamp", status: :fully_qualified, emoji: "🪔"},
      %Emoshi{
      ...
      %Emoshi{slug: "closed-book", name: "closed book", status: :fully_qualified, emoji: "📕"},
      %Emoshi{slug: "open-book", name: "open book", status: :fully_qualified, emoji: "📖"},
      %Emoshi{slug: "green-book", name: "green book", status: :fully_qualified, emoji: "📗"},
      %Emoshi{slug: "blue-book", name: "blue book", status: :fully_qualified, emoji: "📘"},
      %Emoshi{slug: "orange-book", name: "orange book", status: :fully_qualified, emoji: "📙"},
      %Emoshi{slug: "books", name: "books", status: :fully_qualified, emoji: "📚"},
      %Emoshi{slug: "notebook", name: "notebook", status: :fully_qualified, emoji: "📓"},
      %Emoshi{slug: "ledger", name: "ledger", status: :fully_qualified, emoji: "📒"},
      %Emoshi{
        slug: "page-with-curl",
        name: "page with curl",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "scroll", name: "scroll", status: :fully_qualified, emoji: "📜"},
      %Emoshi{
        slug: "page-facing-up",
        name: "page facing up",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "newspaper", name: "newspaper", status: :fully_qualified, emoji: "📰"},
      %Emoshi{
      ...
      %Emoshi{slug: "bookmark-tabs", name: "bookmark tabs", status: :fully_qualified, emoji: "📑"},
      %Emoshi{slug: "bookmark", name: "bookmark", status: :fully_qualified, emoji: "🔖"},
      %Emoshi{slug: "label", name: "label", status: :fully_qualified, emoji: "🏷️"},
      %Emoshi{slug: "money-bag", name: "money bag", status: :fully_qualified, emoji: "💰"},
      %Emoshi{slug: "coin", name: "coin", status: :fully_qualified, emoji: "🪙"},
      %Emoshi{slug: "yen-banknote", name: "yen banknote", status: :fully_qualified, emoji: "💴"},
      %Emoshi{
      ...
      %Emoshi{slug: "euro-banknote", name: "euro banknote", status: :fully_qualified, emoji: "💶"},
      %Emoshi{
        slug: "pound-banknote",
        name: "pound banknote",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "credit-card", name: "credit card", status: :fully_qualified, emoji: "💳"},
      %Emoshi{slug: "receipt", name: "receipt", status: :fully_qualified, emoji: "🧾"},
      %Emoshi{
      ...
      %Emoshi{slug: "envelope", name: "envelope", status: :fully_qualified, emoji: "✉️"},
      %Emoshi{slug: "e-mail", name: "e-mail", status: :fully_qualified, emoji: "📧"},
      %Emoshi{
      ...
      %Emoshi{slug: "outbox-tray", name: "outbox tray", status: :fully_qualified, emoji: "📤"},
      %Emoshi{slug: "inbox-tray", name: "inbox tray", status: :fully_qualified, emoji: "📥"},
      %Emoshi{slug: "package", name: "package", status: :fully_qualified, emoji: "📦"},
      %Emoshi{
      ...
      %Emoshi{slug: "postbox", name: "postbox", status: :fully_qualified, emoji: "📮"},
      %Emoshi{
      ...
      %Emoshi{slug: "pencil", name: "pencil", status: :fully_qualified, emoji: "✏️"},
      %Emoshi{slug: "black-nib", name: "black nib", status: :fully_qualified, emoji: "✒️"},
      %Emoshi{slug: "fountain-pen", name: "fountain pen", status: :fully_qualified, emoji: "🖋️"},
      %Emoshi{slug: "pen", name: "pen", status: :fully_qualified, emoji: "🖊️"},
      %Emoshi{slug: "paintbrush", name: "paintbrush", status: :fully_qualified, emoji: "🖌️"},
      %Emoshi{slug: "crayon", name: "crayon", status: :fully_qualified, emoji: "🖍️"},
      %Emoshi{slug: "memo", name: "memo", status: :fully_qualified, emoji: "📝"},
      %Emoshi{slug: "briefcase", name: "briefcase", status: :fully_qualified, emoji: "💼"},
      %Emoshi{slug: "file-folder", name: "file folder", status: :fully_qualified, emoji: "📁"},
      %Emoshi{
      ...
      %Emoshi{slug: "calendar", name: "calendar", status: :fully_qualified, emoji: "📅"},
      %Emoshi{
      ...
      %Emoshi{slug: "card-index", name: "card index", status: :fully_qualified, emoji: "📇"},
      %Emoshi{
      ...
      %Emoshi{slug: "bar-chart", name: "bar chart", status: :fully_qualified, emoji: "📊"},
      %Emoshi{slug: "clipboard", name: "clipboard", status: :fully_qualified, emoji: "📋"},
      %Emoshi{slug: "pushpin", name: "pushpin", status: :fully_qualified, emoji: "📌"},
      %Emoshi{slug: "round-pushpin", name: "round pushpin", status: :fully_qualified, emoji: "📍"},
      %Emoshi{slug: "paperclip", name: "paperclip", status: :fully_qualified, emoji: "📎"},
      %Emoshi{
      ...
      %Emoshi{slug: "scissors", name: "scissors", status: :fully_qualified, emoji: "✂️"},
      %Emoshi{slug: "card-file-box", name: "card file box", status: :fully_qualified, emoji: "🗃️"},
      %Emoshi{slug: "file-cabinet", name: "file cabinet", status: :fully_qualified, emoji: "🗄️"},
      %Emoshi{slug: "wastebasket", name: "wastebasket", status: :fully_qualified, emoji: "🗑️"},
      %Emoshi{slug: "locked", name: "locked", status: :fully_qualified, emoji: "🔒"},
      %Emoshi{slug: "unlocked", name: "unlocked", status: :fully_qualified, emoji: "🔓"},
      %Emoshi{
      ...
      %Emoshi{slug: "key", name: "key", status: :fully_qualified, emoji: "🔑"},
      %Emoshi{slug: "old-key", name: "old key", status: :fully_qualified, emoji: "🗝️"},
      %Emoshi{slug: "hammer", name: "hammer", status: :fully_qualified, emoji: "🔨"},
      %Emoshi{slug: "axe", name: "axe", status: :fully_qualified, emoji: "🪓"},
      %Emoshi{slug: "pick", name: "pick", status: :fully_qualified, emoji: "⛏️"},
      %Emoshi{
      ...
      %Emoshi{slug: "dagger", name: "dagger", status: :fully_qualified, emoji: "🗡️"},
      %Emoshi{
        slug: "crossed-swords",
        name: "crossed swords",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "bomb", name: "bomb", status: :fully_qualified, emoji: "💣"},
      %Emoshi{slug: "boomerang", name: "boomerang", status: :fully_qualified, emoji: "🪃"},
      %Emoshi{slug: "bow-and-arrow", name: "bow and arrow", status: :fully_qualified, emoji: "🏹"},
      %Emoshi{slug: "shield", name: "shield", status: :fully_qualified, emoji: "🛡️"},
      %Emoshi{slug: "carpentry-saw", name: "carpentry saw", status: :fully_qualified, emoji: "🪚"},
      %Emoshi{slug: "wrench", name: "wrench", status: :fully_qualified, emoji: "🔧"},
      %Emoshi{slug: "screwdriver", name: "screwdriver", status: :fully_qualified, emoji: "🪛"},
      %Emoshi{slug: "nut-and-bolt", name: "nut and bolt", status: :fully_qualified, emoji: "🔩"},
      %Emoshi{slug: "gear", name: "gear", status: :fully_qualified, emoji: "⚙️"},
      %Emoshi{slug: "clamp", name: "clamp", status: :fully_qualified, emoji: "🗜️"},
      %Emoshi{slug: "balance-scale", name: "balance scale", status: :fully_qualified, emoji: "⚖️"},
      %Emoshi{slug: "white-cane", name: "white cane", status: :fully_qualified, emoji: "🦯"},
      %Emoshi{slug: "link", name: "link", status: :fully_qualified, emoji: "🔗"},
      %Emoshi{slug: "broken-chain", name: "broken chain", status: :fully_qualified, emoji: "⛓️‍💥"},
      %Emoshi{slug: "chains", name: "chains", status: :fully_qualified, emoji: "⛓️"},
      %Emoshi{slug: "hook", name: "hook", status: :fully_qualified, emoji: "🪝"},
      %Emoshi{slug: "toolbox", name: "toolbox", status: :fully_qualified, emoji: "🧰"},
      %Emoshi{slug: "magnet", name: "magnet", status: :fully_qualified, emoji: "🧲"},
      %Emoshi{slug: "ladder", name: "ladder", status: :fully_qualified, emoji: "🪜"},
      %Emoshi{slug: "shovel", name: "shovel", status: :fully_qualified, emoji: "🪏"},
      %Emoshi{slug: "alembic", name: "alembic", status: :fully_qualified, emoji: "⚗️"},
      %Emoshi{slug: "test-tube", name: "test tube", status: :fully_qualified, emoji: "🧪"},
      %Emoshi{slug: "petri-dish", name: "petri dish", status: :fully_qualified, emoji: "🧫"},
      %Emoshi{slug: "dna", name: "dna", status: :fully_qualified, emoji: "🧬"},
      %Emoshi{slug: "microscope", name: "microscope", status: :fully_qualified, emoji: "🔬"},
      %Emoshi{slug: "telescope", name: "telescope", status: :fully_qualified, emoji: "🔭"},
      %Emoshi{
      ...
      %Emoshi{slug: "syringe", name: "syringe", status: :fully_qualified, emoji: "💉"},
      %Emoshi{slug: "drop-of-blood", name: "drop of blood", status: :fully_qualified, emoji: "🩸"},
      %Emoshi{slug: "pill", name: "pill", status: :fully_qualified, emoji: "💊"},
      %Emoshi{
      ...
      %Emoshi{slug: "crutch", name: "crutch", status: :fully_qualified, emoji: "🩼"},
      %Emoshi{slug: "stethoscope", name: "stethoscope", status: :fully_qualified, emoji: "🩺"},
      %Emoshi{slug: "x-ray", name: "x-ray", status: :fully_qualified, emoji: "🩻"},
      %Emoshi{slug: "door", name: "door", status: :fully_qualified, emoji: "🚪"},
      %Emoshi{slug: "elevator", name: "elevator", status: :fully_qualified, emoji: "🛗"},
      %Emoshi{slug: "mirror", name: "mirror", status: :fully_qualified, emoji: "🪞"},
      %Emoshi{slug: "window", name: "window", status: :fully_qualified, emoji: "🪟"},
      %Emoshi{slug: "bed", name: "bed", status: :fully_qualified, emoji: "🛏️"},
      %Emoshi{
        slug: "couch-and-lamp",
        name: "couch and lamp",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "chair", name: "chair", status: :fully_qualified, emoji: "🪑"},
      %Emoshi{slug: "toilet", name: "toilet", status: :fully_qualified, emoji: "🚽"},
      %Emoshi{slug: "plunger", name: "plunger", status: :fully_qualified, emoji: "🪠"},
      %Emoshi{slug: "shower", name: "shower", status: :fully_qualified, emoji: "🚿"},
      %Emoshi{slug: "bathtub", name: "bathtub", status: :fully_qualified, emoji: "🛁"},
      %Emoshi{slug: "mouse-trap", name: "mouse trap", status: :fully_qualified, emoji: "🪤"},
      %Emoshi{slug: "razor", name: "razor", status: :fully_qualified, emoji: "🪒"},
      %Emoshi{slug: "lotion-bottle", name: "lotion bottle", status: :fully_qualified, emoji: "🧴"},
      %Emoshi{slug: "safety-pin", name: "safety pin", status: :fully_qualified, emoji: "🧷"},
      %Emoshi{slug: "broom", name: "broom", status: :fully_qualified, emoji: "🧹"},
      %Emoshi{slug: "basket", name: "basket", status: :fully_qualified, emoji: "🧺"},
      %Emoshi{slug: "roll-of-paper", name: "roll of paper", status: :fully_qualified, emoji: "🧻"},
      %Emoshi{slug: "bucket", name: "bucket", status: :fully_qualified, emoji: "🪣"},
      %Emoshi{slug: "soap", name: "soap", status: :fully_qualified, emoji: "🧼"},
      %Emoshi{slug: "bubbles", name: "bubbles", status: :fully_qualified, emoji: "🫧"},
      %Emoshi{slug: "toothbrush", name: "toothbrush", status: :fully_qualified, emoji: "🪥"},
      %Emoshi{slug: "sponge", name: "sponge", status: :fully_qualified, emoji: "🧽"},
      %Emoshi{
      ...
      %Emoshi{slug: "shopping-cart", name: "shopping cart", status: :fully_qualified, emoji: "🛒"},
      %Emoshi{slug: "cigarette", name: "cigarette", status: :fully_qualified, emoji: "🚬"},
      %Emoshi{slug: "coffin", name: "coffin", status: :fully_qualified, emoji: "⚰️"},
      %Emoshi{slug: "headstone", name: "headstone", status: :fully_qualified, emoji: "🪦"},
      %Emoshi{slug: "funeral-urn", name: "funeral urn", status: :fully_qualified, emoji: "⚱️"},
      %Emoshi{slug: "nazar-amulet", name: "nazar amulet", status: :fully_qualified, emoji: "🧿"},
      %Emoshi{slug: "hamsa", name: "hamsa", status: :fully_qualified, emoji: "🪬"},
      %Emoshi{slug: "moai", name: "moai", status: :fully_qualified, emoji: "🗿"},
      %Emoshi{slug: "placard", name: "placard", status: :fully_qualified, emoji: "🪧"},
      %Emoshi{
      ...
      %Emoshi{slug: "atm-sign", name: "ATM sign", status: :fully_qualified, emoji: "🏧"},
      %Emoshi{
      ...
      %Emoshi{slug: "potable-water", name: "potable water", status: :fully_qualified, emoji: "🚰"},
      %Emoshi{
      ...
      %Emoshi{slug: "men-s-room", name: "men’s room", status: :fully_qualified, emoji: "🚹"},
      %Emoshi{slug: "women-s-room", name: "women’s room", status: :fully_qualified, emoji: "🚺"},
      %Emoshi{slug: "restroom", name: "restroom", status: :fully_qualified, emoji: "🚻"},
      %Emoshi{slug: "baby-symbol", name: "baby symbol", status: :fully_qualified, emoji: "🚼"},
      %Emoshi{slug: "water-closet", name: "water closet", status: :fully_qualified, emoji: "🚾"},
      %Emoshi{
      ...
      %Emoshi{slug: "customs", name: "customs", status: :fully_qualified, emoji: "🛃"},
      %Emoshi{slug: "baggage-claim", name: "baggage claim", status: :fully_qualified, emoji: "🛄"},
      %Emoshi{slug: "left-luggage", name: "left luggage", status: :fully_qualified, emoji: "🛅"},
      %Emoshi{slug: "warning", name: "warning", status: :fully_qualified, emoji: "⚠️"},
      %Emoshi{
      ...
      %Emoshi{slug: "no-entry", name: "no entry", status: :fully_qualified, emoji: "⛔"},
      %Emoshi{slug: "prohibited", name: "prohibited", status: :fully_qualified, emoji: "🚫"},
      %Emoshi{slug: "no-bicycles", name: "no bicycles", status: :fully_qualified, emoji: "🚳"},
      %Emoshi{slug: "no-smoking", name: "no smoking", status: :fully_qualified, emoji: "🚭"},
      %Emoshi{slug: "no-littering", name: "no littering", status: :fully_qualified, emoji: "🚯"},
      %Emoshi{
      ...
      %Emoshi{slug: "radioactive", name: "radioactive", status: :fully_qualified, emoji: "☢️"},
      %Emoshi{slug: "biohazard", name: "biohazard", status: :fully_qualified, emoji: "☣️"},
      %Emoshi{slug: "up-arrow", name: "up arrow", status: :fully_qualified, emoji: "⬆️"},
      %Emoshi{
        slug: "up-right-arrow",
        name: "up-right arrow",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "right-arrow", name: "right arrow", status: :fully_qualified, emoji: "➡️"},
      %Emoshi{
      ...
      %Emoshi{slug: "down-arrow", name: "down arrow", status: :fully_qualified, emoji: "⬇️"},
      %Emoshi{
      ...
      %Emoshi{slug: "left-arrow", name: "left arrow", status: :fully_qualified, emoji: "⬅️"},
      %Emoshi{slug: "up-left-arrow", name: "up-left arrow", status: :fully_qualified, emoji: "↖️"},
      %Emoshi{slug: "up-down-arrow", name: "up-down arrow", status: :fully_qualified, emoji: "↕️"},
      %Emoshi{
      ...
      %Emoshi{slug: "back-arrow", name: "BACK arrow", status: :fully_qualified, emoji: "🔙"},
      %Emoshi{slug: "end-arrow", name: "END arrow", status: :fully_qualified, emoji: "🔚"},
      %Emoshi{slug: "on-arrow", name: "ON! arrow", status: :fully_qualified, emoji: "🔛"},
      %Emoshi{slug: "soon-arrow", name: "SOON arrow", status: :fully_qualified, emoji: "🔜"},
      %Emoshi{slug: "top-arrow", name: "TOP arrow", status: :fully_qualified, emoji: "🔝"},
      %Emoshi{
      ...
      %Emoshi{slug: "atom-symbol", name: "atom symbol", status: :fully_qualified, emoji: "⚛️"},
      %Emoshi{slug: "om", name: "om", status: :fully_qualified, emoji: "🕉️"},
      %Emoshi{slug: "star-of-david", name: "star of David", status: :fully_qualified, emoji: "✡️"},
      %Emoshi{
      ...
      %Emoshi{slug: "yin-yang", name: "yin yang", status: :fully_qualified, emoji: "☯️"},
      %Emoshi{slug: "latin-cross", name: "latin cross", status: :fully_qualified, emoji: "✝️"},
      %Emoshi{
        slug: "orthodox-cross",
        name: "orthodox cross",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "peace-symbol", name: "peace symbol", status: :fully_qualified, emoji: "☮️"},
      %Emoshi{slug: "menorah", name: "menorah", status: :fully_qualified, emoji: "🕎"},
      %Emoshi{
      ...
      %Emoshi{slug: "khanda", name: "khanda", status: :fully_qualified, emoji: "🪯"},
      %Emoshi{slug: "aries", name: "Aries", status: :fully_qualified, emoji: "♈"},
      %Emoshi{slug: "taurus", name: "Taurus", status: :fully_qualified, emoji: "♉"},
      %Emoshi{slug: "gemini", name: "Gemini", status: :fully_qualified, emoji: "♊"},
      %Emoshi{slug: "cancer", name: "Cancer", status: :fully_qualified, emoji: "♋"},
      %Emoshi{slug: "leo", name: "Leo", status: :fully_qualified, emoji: "♌"},
      %Emoshi{slug: "virgo", name: "Virgo", status: :fully_qualified, emoji: "♍"},
      %Emoshi{slug: "libra", name: "Libra", status: :fully_qualified, emoji: "♎"},
      %Emoshi{slug: "scorpio", name: "Scorpio", status: :fully_qualified, emoji: "♏"},
      %Emoshi{slug: "sagittarius", name: "Sagittarius", status: :fully_qualified, emoji: "♐"},
      %Emoshi{slug: "capricorn", name: "Capricorn", status: :fully_qualified, emoji: "♑"},
      %Emoshi{slug: "aquarius", name: "Aquarius", status: :fully_qualified, emoji: "♒"},
      %Emoshi{slug: "pisces", name: "Pisces", status: :fully_qualified, emoji: "♓"},
      %Emoshi{slug: "ophiuchus", name: "Ophiuchus", status: :fully_qualified, emoji: "⛎"},
      %Emoshi{
      ...
      %Emoshi{slug: "repeat-button", name: "repeat button", status: :fully_qualified, emoji: "🔁"},
      %Emoshi{
      ...
      %Emoshi{slug: "play-button", name: "play button", status: :fully_qualified, emoji: "▶️"},
      %Emoshi{
      ...
      %Emoshi{slug: "pause-button", name: "pause button", status: :fully_qualified, emoji: "⏸️"},
      %Emoshi{slug: "stop-button", name: "stop button", status: :fully_qualified, emoji: "⏹️"},
      %Emoshi{slug: "record-button", name: "record button", status: :fully_qualified, emoji: "⏺️"},
      %Emoshi{slug: "eject-button", name: "eject button", status: :fully_qualified, emoji: "⏏️"},
      %Emoshi{slug: "cinema", name: "cinema", status: :fully_qualified, emoji: "🎦"},
      %Emoshi{slug: "dim-button", name: "dim button", status: :fully_qualified, emoji: "🔅"},
      %Emoshi{slug: "bright-button", name: "bright button", status: :fully_qualified, emoji: "🔆"},
      %Emoshi{slug: "antenna-bars", name: "antenna bars", status: :fully_qualified, emoji: "📶"},
      %Emoshi{slug: "wireless", name: "wireless", status: :fully_qualified, emoji: "🛜"},
      %Emoshi{
        slug: "vibration-mode",
        name: "vibration mode",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "female-sign", name: "female sign", status: :fully_qualified, emoji: "♀️"},
      %Emoshi{slug: "male-sign", name: "male sign", status: :fully_qualified, emoji: "♂️"},
      %Emoshi{
      ...
      %Emoshi{slug: "multiply", name: "multiply", status: :fully_qualified, emoji: "✖️"},
      %Emoshi{slug: "plus", name: "plus", status: :fully_qualified, emoji: "➕"},
      %Emoshi{slug: "minus", name: "minus", status: :fully_qualified, emoji: "➖"},
      %Emoshi{slug: "divide", name: "divide", status: :fully_qualified, emoji: "➗"},
      %Emoshi{
      ...
      %Emoshi{slug: "infinity", name: "infinity", status: :fully_qualified, emoji: "♾️"},
      %Emoshi{
      ...
      %Emoshi{slug: "wavy-dash", name: "wavy dash", status: :fully_qualified, emoji: "〰️"},
      %Emoshi{
      ...
      %Emoshi{slug: "fleur-de-lis", name: "fleur-de-lis", status: :fully_qualified, emoji: "⚜️"},
      %Emoshi{
        slug: "trident-emblem",
        name: "trident emblem",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "name-badge", name: "name badge", status: :fully_qualified, emoji: "📛"},
      %Emoshi{
      ...
      %Emoshi{slug: "check-mark", name: "check mark", status: :fully_qualified, emoji: "✔️"},
      %Emoshi{slug: "cross-mark", name: "cross mark", status: :fully_qualified, emoji: "❌"},
      %Emoshi{
      ...
      %Emoshi{slug: "curly-loop", name: "curly loop", status: :fully_qualified, emoji: "➰"},
      %Emoshi{
      ...
      %Emoshi{slug: "sparkle", name: "sparkle", status: :fully_qualified, emoji: "❇️"},
      %Emoshi{slug: "copyright", name: "copyright", status: :fully_qualified, emoji: "©️"},
      %Emoshi{slug: "registered", name: "registered", status: :fully_qualified, emoji: "®️"},
      %Emoshi{slug: "trade-mark", name: "trade mark", status: :fully_qualified, emoji: "™️"},
      %Emoshi{slug: "splatter", name: "splatter", status: :fully_qualified, emoji: "🫟"},
      %Emoshi{
      ...
      %Emoshi{slug: "keycap-asterik", name: "keycap: *", status: :fully_qualified, emoji: "*️⃣"},
      %Emoshi{slug: "keycap-0", name: "keycap: 0", status: :fully_qualified, emoji: "0️⃣"},
      %Emoshi{slug: "keycap-1", name: "keycap: 1", status: :fully_qualified, emoji: "1️⃣"},
      %Emoshi{slug: "keycap-2", name: "keycap: 2", status: :fully_qualified, emoji: "2️⃣"},
      %Emoshi{slug: "keycap-3", name: "keycap: 3", status: :fully_qualified, emoji: "3️⃣"},
      %Emoshi{slug: "keycap-4", name: "keycap: 4", status: :fully_qualified, emoji: "4️⃣"},
      %Emoshi{slug: "keycap-5", name: "keycap: 5", status: :fully_qualified, emoji: "5️⃣"},
      %Emoshi{slug: "keycap-6", name: "keycap: 6", status: :fully_qualified, emoji: "6️⃣"},
      %Emoshi{slug: "keycap-7", name: "keycap: 7", status: :fully_qualified, emoji: "7️⃣"},
      %Emoshi{slug: "keycap-8", name: "keycap: 8", status: :fully_qualified, emoji: "8️⃣"},
      %Emoshi{slug: "keycap-9", name: "keycap: 9", status: :fully_qualified, emoji: "9️⃣"},
      %Emoshi{slug: "keycap-10", name: "keycap: 10", status: :fully_qualified, emoji: "🔟"},
      %Emoshi{
      ...
      %Emoshi{slug: "input-numbers", name: "input numbers", status: :fully_qualified, emoji: "🔢"},
      %Emoshi{slug: "input-symbols", name: "input symbols", status: :fully_qualified, emoji: "🔣"},
      %Emoshi{
      ...
      %Emoshi{slug: "cl-button", name: "CL button", status: :fully_qualified, emoji: "🆑"},
      %Emoshi{slug: "cool-button", name: "COOL button", status: :fully_qualified, emoji: "🆒"},
      %Emoshi{slug: "free-button", name: "FREE button", status: :fully_qualified, emoji: "🆓"},
      %Emoshi{slug: "information", name: "information", status: :fully_qualified, emoji: "ℹ️"},
      %Emoshi{slug: "id-button", name: "ID button", status: :fully_qualified, emoji: "🆔"},
      %Emoshi{slug: "circled-m", name: "circled M", status: :fully_qualified, emoji: "Ⓜ️"},
      %Emoshi{slug: "new-button", name: "NEW button", status: :fully_qualified, emoji: "🆕"},
      %Emoshi{slug: "ng-button", name: "NG button", status: :fully_qualified, emoji: "🆖"},
      %Emoshi{
      ...
      %Emoshi{slug: "ok-button", name: "OK button", status: :fully_qualified, emoji: "🆗"},
      %Emoshi{slug: "p-button", name: "P button", status: :fully_qualified, emoji: "🅿️"},
      %Emoshi{slug: "sos-button", name: "SOS button", status: :fully_qualified, emoji: "🆘"},
      %Emoshi{slug: "up-button", name: "UP! button", status: :fully_qualified, emoji: "🆙"},
      %Emoshi{slug: "vs-button", name: "VS button", status: :fully_qualified, emoji: "🆚"},
      %Emoshi{
      ...
      %Emoshi{slug: "red-circle", name: "red circle", status: :fully_qualified, emoji: "🔴"},
      %Emoshi{slug: "orange-circle", name: "orange circle", status: :fully_qualified, emoji: "🟠"},
      %Emoshi{slug: "yellow-circle", name: "yellow circle", status: :fully_qualified, emoji: "🟡"},
      %Emoshi{slug: "green-circle", name: "green circle", status: :fully_qualified, emoji: "🟢"},
      %Emoshi{slug: "blue-circle", name: "blue circle", status: :fully_qualified, emoji: "🔵"},
      %Emoshi{slug: "purple-circle", name: "purple circle", status: :fully_qualified, emoji: "🟣"},
      %Emoshi{slug: "brown-circle", name: "brown circle", status: :fully_qualified, emoji: "🟤"},
      %Emoshi{slug: "black-circle", name: "black circle", status: :fully_qualified, emoji: "⚫"},
      %Emoshi{slug: "white-circle", name: "white circle", status: :fully_qualified, emoji: "⚪"},
      %Emoshi{slug: "red-square", name: "red square", status: :fully_qualified, emoji: "🟥"},
      %Emoshi{slug: "orange-square", name: "orange square", status: :fully_qualified, emoji: "🟧"},
      %Emoshi{slug: "yellow-square", name: "yellow square", status: :fully_qualified, emoji: "🟨"},
      %Emoshi{slug: "green-square", name: "green square", status: :fully_qualified, emoji: "🟩"},
      %Emoshi{slug: "blue-square", name: "blue square", status: :fully_qualified, emoji: "🟦"},
      %Emoshi{slug: "purple-square", name: "purple square", status: :fully_qualified, emoji: "🟪"},
      %Emoshi{slug: "brown-square", name: "brown square", status: :fully_qualified, emoji: "🟫"},
      %Emoshi{
      ...
      %Emoshi{slug: "radio-button", name: "radio button", status: :fully_qualified, emoji: "🔘"},
      %Emoshi{
      ...
      %Emoshi{slug: "crossed-flags", name: "crossed flags", status: :fully_qualified, emoji: "🎌"},
      %Emoshi{slug: "black-flag", name: "black flag", status: :fully_qualified, emoji: "🏴"},
      %Emoshi{slug: "white-flag", name: "white flag", status: :fully_qualified, emoji: "🏳️"},
      %Emoshi{slug: "rainbow-flag", name: "rainbow flag", status: :fully_qualified, emoji: "🏳️‍🌈"},
      %Emoshi{
      ...
      %Emoshi{slug: "pirate-flag", name: "pirate flag", status: :fully_qualified, emoji: "🏴‍☠️"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-andorra", name: "flag: Andorra", status: :fully_qualified, emoji: "🇦🇩"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-albania", name: "flag: Albania", status: :fully_qualified, emoji: "🇦🇱"},
      %Emoshi{slug: "flag-armenia", name: "flag: Armenia", status: :fully_qualified, emoji: "🇦🇲"},
      %Emoshi{slug: "flag-angola", name: "flag: Angola", status: :fully_qualified, emoji: "🇦🇴"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-austria", name: "flag: Austria", status: :fully_qualified, emoji: "🇦🇹"},
      %Emoshi{
        slug: "flag-australia",
        name: "flag: Australia",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-aruba", name: "flag: Aruba", status: :fully_qualified, emoji: "🇦🇼"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-belgium", name: "flag: Belgium", status: :fully_qualified, emoji: "🇧🇪"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-bahrain", name: "flag: Bahrain", status: :fully_qualified, emoji: "🇧🇭"},
      %Emoshi{slug: "flag-burundi", name: "flag: Burundi", status: :fully_qualified, emoji: "🇧🇮"},
      %Emoshi{slug: "flag-benin", name: "flag: Benin", status: :fully_qualified, emoji: "🇧🇯"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-bermuda", name: "flag: Bermuda", status: :fully_qualified, emoji: "🇧🇲"},
      %Emoshi{slug: "flag-brunei", name: "flag: Brunei", status: :fully_qualified, emoji: "🇧🇳"},
      %Emoshi{slug: "flag-bolivia", name: "flag: Bolivia", status: :fully_qualified, emoji: "🇧🇴"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-brazil", name: "flag: Brazil", status: :fully_qualified, emoji: "🇧🇷"},
      %Emoshi{slug: "flag-bahamas", name: "flag: Bahamas", status: :fully_qualified, emoji: "🇧🇸"},
      %Emoshi{slug: "flag-bhutan", name: "flag: Bhutan", status: :fully_qualified, emoji: "🇧🇹"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-belarus", name: "flag: Belarus", status: :fully_qualified, emoji: "🇧🇾"},
      %Emoshi{slug: "flag-belize", name: "flag: Belize", status: :fully_qualified, emoji: "🇧🇿"},
      %Emoshi{slug: "flag-canada", name: "flag: Canada", status: :fully_qualified, emoji: "🇨🇦"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-chile", name: "flag: Chile", status: :fully_qualified, emoji: "🇨🇱"},
      %Emoshi{
        slug: "flag-cameroon",
        name: "flag: Cameroon",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-china", name: "flag: China", status: :fully_qualified, emoji: "🇨🇳"},
      %Emoshi{
        slug: "flag-colombia",
        name: "flag: Colombia",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-sark", name: "flag: Sark", status: :fully_qualified, emoji: "🇨🇶"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-cuba", name: "flag: Cuba", status: :fully_qualified, emoji: "🇨🇺"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-curac-ao", name: "flag: Curaçao", status: :fully_qualified, emoji: "🇨🇼"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-cyprus", name: "flag: Cyprus", status: :fully_qualified, emoji: "🇨🇾"},
      %Emoshi{slug: "flag-czechia", name: "flag: Czechia", status: :fully_qualified, emoji: "🇨🇿"},
      %Emoshi{slug: "flag-germany", name: "flag: Germany", status: :fully_qualified, emoji: "🇩🇪"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-denmark", name: "flag: Denmark", status: :fully_qualified, emoji: "🇩🇰"},
      %Emoshi{
        slug: "flag-dominica",
        name: "flag: Dominica",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-algeria", name: "flag: Algeria", status: :fully_qualified, emoji: "🇩🇿"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-ecuador", name: "flag: Ecuador", status: :fully_qualified, emoji: "🇪🇨"},
      %Emoshi{slug: "flag-estonia", name: "flag: Estonia", status: :fully_qualified, emoji: "🇪🇪"},
      %Emoshi{slug: "flag-egypt", name: "flag: Egypt", status: :fully_qualified, emoji: "🇪🇬"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-eritrea", name: "flag: Eritrea", status: :fully_qualified, emoji: "🇪🇷"},
      %Emoshi{slug: "flag-spain", name: "flag: Spain", status: :fully_qualified, emoji: "🇪🇸"},
      %Emoshi{
        slug: "flag-ethiopia",
        name: "flag: Ethiopia",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-finland", name: "flag: Finland", status: :fully_qualified, emoji: "🇫🇮"},
      %Emoshi{slug: "flag-fiji", name: "flag: Fiji", status: :fully_qualified, emoji: "🇫🇯"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-france", name: "flag: France", status: :fully_qualified, emoji: "🇫🇷"},
      %Emoshi{slug: "flag-gabon", name: "flag: Gabon", status: :fully_qualified, emoji: "🇬🇦"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-grenada", name: "flag: Grenada", status: :fully_qualified, emoji: "🇬🇩"},
      %Emoshi{slug: "flag-georgia", name: "flag: Georgia", status: :fully_qualified, emoji: "🇬🇪"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-ghana", name: "flag: Ghana", status: :fully_qualified, emoji: "🇬🇭"},
      %Emoshi{
        slug: "flag-gibraltar",
        name: "flag: Gibraltar",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-gambia", name: "flag: Gambia", status: :fully_qualified, emoji: "🇬🇲"},
      %Emoshi{slug: "flag-guinea", name: "flag: Guinea", status: :fully_qualified, emoji: "🇬🇳"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-greece", name: "flag: Greece", status: :fully_qualified, emoji: "🇬🇷"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-guam", name: "flag: Guam", status: :fully_qualified, emoji: "🇬🇺"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-guyana", name: "flag: Guyana", status: :fully_qualified, emoji: "🇬🇾"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-croatia", name: "flag: Croatia", status: :fully_qualified, emoji: "🇭🇷"},
      %Emoshi{slug: "flag-haiti", name: "flag: Haiti", status: :fully_qualified, emoji: "🇭🇹"},
      %Emoshi{slug: "flag-hungary", name: "flag: Hungary", status: :fully_qualified, emoji: "🇭🇺"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-ireland", name: "flag: Ireland", status: :fully_qualified, emoji: "🇮🇪"},
      %Emoshi{slug: "flag-israel", name: "flag: Israel", status: :fully_qualified, emoji: "🇮🇱"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-india", name: "flag: India", status: :fully_qualified, emoji: "🇮🇳"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-iraq", name: "flag: Iraq", status: :fully_qualified, emoji: "🇮🇶"},
      %Emoshi{slug: "flag-iran", name: "flag: Iran", status: :fully_qualified, emoji: "🇮🇷"},
      %Emoshi{slug: "flag-iceland", name: "flag: Iceland", status: :fully_qualified, emoji: "🇮🇸"},
      %Emoshi{slug: "flag-italy", name: "flag: Italy", status: :fully_qualified, emoji: "🇮🇹"},
      %Emoshi{slug: "flag-jersey", name: "flag: Jersey", status: :fully_qualified, emoji: "🇯🇪"},
      %Emoshi{slug: "flag-jamaica", name: "flag: Jamaica", status: :fully_qualified, emoji: "🇯🇲"},
      %Emoshi{slug: "flag-jordan", name: "flag: Jordan", status: :fully_qualified, emoji: "🇯🇴"},
      %Emoshi{slug: "flag-japan", name: "flag: Japan", status: :fully_qualified, emoji: "🇯🇵"},
      %Emoshi{slug: "flag-kenya", name: "flag: Kenya", status: :fully_qualified, emoji: "🇰🇪"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-comoros", name: "flag: Comoros", status: :fully_qualified, emoji: "🇰🇲"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-kuwait", name: "flag: Kuwait", status: :fully_qualified, emoji: "🇰🇼"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-laos", name: "flag: Laos", status: :fully_qualified, emoji: "🇱🇦"},
      %Emoshi{slug: "flag-lebanon", name: "flag: Lebanon", status: :fully_qualified, emoji: "🇱🇧"},
      %Emoshi{
        slug: "flag-st-lucia",
        name: "flag: St. Lucia",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-liberia", name: "flag: Liberia", status: :fully_qualified, emoji: "🇱🇷"},
      %Emoshi{slug: "flag-lesotho", name: "flag: Lesotho", status: :fully_qualified, emoji: "🇱🇸"},
      %Emoshi{
        slug: "flag-lithuania",
        name: "flag: Lithuania",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-latvia", name: "flag: Latvia", status: :fully_qualified, emoji: "🇱🇻"},
      %Emoshi{slug: "flag-libya", name: "flag: Libya", status: :fully_qualified, emoji: "🇱🇾"},
      %Emoshi{slug: "flag-morocco", name: "flag: Morocco", status: :fully_qualified, emoji: "🇲🇦"},
      %Emoshi{slug: "flag-monaco", name: "flag: Monaco", status: :fully_qualified, emoji: "🇲🇨"},
      %Emoshi{slug: "flag-moldova", name: "flag: Moldova", status: :fully_qualified, emoji: "🇲🇩"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-mali", name: "flag: Mali", status: :fully_qualified, emoji: "🇲🇱"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-malta", name: "flag: Malta", status: :fully_qualified, emoji: "🇲🇹"},
      %Emoshi{
        slug: "flag-mauritius",
        name: "flag: Mauritius",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-malawi", name: "flag: Malawi", status: :fully_qualified, emoji: "🇲🇼"},
      %Emoshi{slug: "flag-mexico", name: "flag: Mexico", status: :fully_qualified, emoji: "🇲🇽"},
      %Emoshi{
        slug: "flag-malaysia",
        name: "flag: Malaysia",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-namibia", name: "flag: Namibia", status: :fully_qualified, emoji: "🇳🇦"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-niger", name: "flag: Niger", status: :fully_qualified, emoji: "🇳🇪"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-nigeria", name: "flag: Nigeria", status: :fully_qualified, emoji: "🇳🇬"},
      %Emoshi{
        slug: "flag-nicaragua",
        name: "flag: Nicaragua",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-norway", name: "flag: Norway", status: :fully_qualified, emoji: "🇳🇴"},
      %Emoshi{slug: "flag-nepal", name: "flag: Nepal", status: :fully_qualified, emoji: "🇳🇵"},
      %Emoshi{slug: "flag-nauru", name: "flag: Nauru", status: :fully_qualified, emoji: "🇳🇷"},
      %Emoshi{slug: "flag-niue", name: "flag: Niue", status: :fully_qualified, emoji: "🇳🇺"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-oman", name: "flag: Oman", status: :fully_qualified, emoji: "🇴🇲"},
      %Emoshi{slug: "flag-panama", name: "flag: Panama", status: :fully_qualified, emoji: "🇵🇦"},
      %Emoshi{slug: "flag-peru", name: "flag: Peru", status: :fully_qualified, emoji: "🇵🇪"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-poland", name: "flag: Poland", status: :fully_qualified, emoji: "🇵🇱"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-palau", name: "flag: Palau", status: :fully_qualified, emoji: "🇵🇼"},
      %Emoshi{
        slug: "flag-paraguay",
        name: "flag: Paraguay",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-qatar", name: "flag: Qatar", status: :fully_qualified, emoji: "🇶🇦"},
      %Emoshi{slug: "flag-re-union", name: "flag: Réunion", status: :fully_qualified, emoji: "🇷🇪"},
      %Emoshi{slug: "flag-romania", name: "flag: Romania", status: :fully_qualified, emoji: "🇷🇴"},
      %Emoshi{slug: "flag-serbia", name: "flag: Serbia", status: :fully_qualified, emoji: "🇷🇸"},
      %Emoshi{slug: "flag-russia", name: "flag: Russia", status: :fully_qualified, emoji: "🇷🇺"},
      %Emoshi{slug: "flag-rwanda", name: "flag: Rwanda", status: :fully_qualified, emoji: "🇷🇼"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-sudan", name: "flag: Sudan", status: :fully_qualified, emoji: "🇸🇩"},
      %Emoshi{slug: "flag-sweden", name: "flag: Sweden", status: :fully_qualified, emoji: "🇸🇪"},
      %Emoshi{
        slug: "flag-singapore",
        name: "flag: Singapore",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-senegal", name: "flag: Senegal", status: :fully_qualified, emoji: "🇸🇳"},
      %Emoshi{slug: "flag-somalia", name: "flag: Somalia", status: :fully_qualified, emoji: "🇸🇴"},
      %Emoshi{
        slug: "flag-suriname",
        name: "flag: Suriname",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-syria", name: "flag: Syria", status: :fully_qualified, emoji: "🇸🇾"},
      %Emoshi{
        slug: "flag-eswatini",
        name: "flag: Eswatini",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-chad", name: "flag: Chad", status: :fully_qualified, emoji: "🇹🇩"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-togo", name: "flag: Togo", status: :fully_qualified, emoji: "🇹🇬"},
      %Emoshi{
        slug: "flag-thailand",
        name: "flag: Thailand",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-tokelau", name: "flag: Tokelau", status: :fully_qualified, emoji: "🇹🇰"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-tunisia", name: "flag: Tunisia", status: :fully_qualified, emoji: "🇹🇳"},
      %Emoshi{slug: "flag-tonga", name: "flag: Tonga", status: :fully_qualified, emoji: "🇹🇴"},
      %Emoshi{slug: "flag-tu-rkiye", name: "flag: Türkiye", status: :fully_qualified, emoji: "🇹🇷"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-tuvalu", name: "flag: Tuvalu", status: :fully_qualified, emoji: "🇹🇻"},
      %Emoshi{slug: "flag-taiwan", name: "flag: Taiwan", status: :fully_qualified, emoji: "🇹🇼"},
      %Emoshi{
        slug: "flag-tanzania",
        name: "flag: Tanzania",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-ukraine", name: "flag: Ukraine", status: :fully_qualified, emoji: "🇺🇦"},
      %Emoshi{slug: "flag-uganda", name: "flag: Uganda", status: :fully_qualified, emoji: "🇺🇬"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-uruguay", name: "flag: Uruguay", status: :fully_qualified, emoji: "🇺🇾"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-vietnam", name: "flag: Vietnam", status: :fully_qualified, emoji: "🇻🇳"},
      %Emoshi{slug: "flag-vanuatu", name: "flag: Vanuatu", status: :fully_qualified, emoji: "🇻🇺"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-samoa", name: "flag: Samoa", status: :fully_qualified, emoji: "🇼🇸"},
      %Emoshi{slug: "flag-kosovo", name: "flag: Kosovo", status: :fully_qualified, emoji: "🇽🇰"},
      %Emoshi{slug: "flag-yemen", name: "flag: Yemen", status: :fully_qualified, emoji: "🇾🇪"},
      %Emoshi{slug: "flag-mayotte", name: "flag: Mayotte", status: :fully_qualified, emoji: "🇾🇹"},
      %Emoshi{
      ...
      %Emoshi{slug: "flag-zambia", name: "flag: Zambia", status: :fully_qualified, emoji: "🇿🇲"},
      %Emoshi{
        slug: "flag-zimbabwe",
        name: "flag: Zimbabwe",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-england", name: "flag: England", status: :fully_qualified, emoji: "🏴󠁧󠁢󠁥󠁮󠁧󠁿"},
      %Emoshi{
        slug: "flag-scotland",
        name: "flag: Scotland",
        status: :fully_qualified,
      ...
      %Emoshi{slug: "flag-wales", name: "flag: Wales", status: :fully_qualified, emoji: "🏴󠁧󠁢󠁷󠁬󠁳󠁿"}
    ]
  end
